 ...
 * 样板点评指标信息
 */
public class ProjectSampleCheckDetailsDTO {
    ...
    private List<ProjectSampleCheckChangedDTO> sampleCheckChanged;//样板点评指标整改信息
    private List<SampleCheckImageDTO> imageList;
    private List<SampleCheckImageDTO> image2List;
    public ProjectSampleCheckDetailsDTO(){
        this.id="";
        this.sampleCheckId="";
        this.targetId="";
        this.targetName="";
        ...
        this.modifyDate="";
        this.flag="";
        this.sampleCheckChanged=new ArrayList<ProjectSampleCheckChangedDTO>();
    ...
    public List<ProjectSampleCheckChangedDTO> getSampleCheckChanged() {
        return sampleCheckChanged;
    }

    public void setSampleCheckChanged(List<ProjectSampleCheckChangedDTO> sampleCheckChanged) {
        this.sampleCheckChanged = sampleCheckChanged;
    }
