        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (code != 0) {
                    ...
                    window.location.href = "../property/PropertyAnywhereReport.html?pageIndex="+pages+"&houseId="+houseId+"&makedateStart="+makedateStart+"&makedateEnd="+makedateEnd+"&userName="+userName;
                }
            },
        });
    }
