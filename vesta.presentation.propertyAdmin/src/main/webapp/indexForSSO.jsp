...
<head>
  ...
  <script>
    new WOW().init();
    setTimeout(function(){$("#jump").submit();},5000);
  </script>
  <!--//end-animate-->
  <!-- Metis Menu -->
            ...
            <div class="col-md-6 validation-grids validation-grids-right">
              <div class="widget-shadow " data-example-id="basic-forms">
                <div class="form-title">
                  <h4>欢迎您使用万达物管社区APP管理系统，正在为您跳转，请稍后...</h4>
                </div>
                <div class="form-body">
                  <form id="jump" name="jump" class="form-horizontal" action="./login/gotoSSOCheck.html" method="post">
                    <div class="col-sm-offset-2">
                        如果5秒钟未进行跳转，请点击
                      <button type="submit" class="btn btn-default">进入系统</button> </div>
                  </form>
                </div>
              </div>
            </div>
