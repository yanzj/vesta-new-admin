        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body" style="overflow:hidden;font-size:13px;line-height:25px;font-family:'微软雅黑';">
                <form class="form-horizontal" id="fromAdd" action="../electronicMagazine/saveOrUpdateElectronicMagazineInfo.html" method="post" enctype="MULTIPART/FORM-DATA">
                    ...
                    <div class="allColumn">
                        <button class="addColumn" type="button" onclick="addColumn()">添加栏目</button>
                        <div class="singerColumn clearfix">
                            <%-- 栏目 --%>
                            <div class="form-group col-lg-7">
                                <label class="col-sm-3 control-label">栏目</label>
                                <div class="col-sm-5">
                                    <input id="columnImgUpload" name="columnImgFile" type="file" multiple/>
                                    <input type="hidden" id="columnImgUrl" name="columnImgUrl" value=""/>
                                </div>
                            </div>
                            <%-- 栏目原图 --%>
                            <div id="columnImg" class="form-group col-lg-7" style="display: none">
                                <label class="col-sm-3 control-label">栏目原图</label>
                                <div class="col-sm-5">
                                    <img src="" alt="栏目原图" class="img-thumbnail" style="width: auto">
                                </div>
                            </div>
                            <%-- 内容 --%>
                            <div class="allContent">
                                <button class="addContent" onclick="addcontent">添加内容</button>
                                <div class="singerContent clearfix">
                                    <div class="form-group col-lg-7">
                                        <label class="col-sm-3 control-label">内容</label>
                                        <div class="col-sm-5">
                                            <input id="contentImgUpload" name="contentImgFile" type="file" multiple/>
                                            <input type="hidden" id="contentImgUrl" name="contentImgUrl" value=""/>
                                        </div>
                                    </div>
                                    <%-- 内容原图 --%>
                                    <div id="contentImg" class="form-group col-lg-7" style="display: none">
                                        <label class="col-sm-3 control-label">内容原图</label>
                                        <div class="col-sm-5">
                                            <img src="" alt="栏目原图" class="img-thumbnail" style="width: auto">
                                        </div>
                                    </div>
...
<script>
    function addColumn() {
        var ColumnData =
            ...
            '<div class="form-group col-lg-7">'+
            '<label class="col-sm-3 control-label">栏目</label>'+
            '<div class="col-sm-5">'+ '<input id="columnImgUpload" name="columnImgFile" type="file" multiple/>'+
            '<input type="hidden" id="columnImgUrl" name="columnImgUrl" value=""/>'+
            '</div>'+
            '</div>'+
            '<div id="columnImg" class="form-group col-lg-7" style="display: none">'+
            ...
            '</div>'+
            '<div class="allContent">'+
            '<button type="button" class="addContent" onclick="addcontent()">添加内容</button>'+
            '<div class="singerContent clearfix">'+
            '<div class="form-group col-lg-7">'+
            '<label class="col-sm-3 control-label">内容</label>'+
            '<div class="col-sm-5">'+
    ...
    function addcontent(event) {
         ...
         var ContentData =
            ...
            '</div>'+
            '</div>';
            e.target.parentNode.innerHTML+=ContentData;
//                '<div class="form-group col-lg-7">'+
//                '<label class="col-sm-3 control-label">内容</label>'+
//                '<div class="col-sm-5">'+
//                '<input id="contentImgUpload" name="contentImgFile" type="file" multiple/>'+
