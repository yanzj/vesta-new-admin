...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../statistics/RepairStatistics.html">
  ...
  <div class="table-responsive bs-example widget-shadow">
    <table width="100%" class="tableStyle">
      ...
      <tr>
        ...
        <th><spring:message code="statistics.repairNumber" /></th>
        <th><spring:message code="statistics.noSolvedNumber" /></th>
        <th><spring:message code="statistics.yesSolvedNumber" /></th>
      </tr>
      </thead>
      <tbody>
      <c:forEach items="${repair}" var="rep" varStatus="row">
        <tr>
          <td><b>${row.index + 1}</b></td>
          <td>${rep.projectName}</td>
          <td>${rep.repairNumber}</td>
          <td>${rep.noSolvedNumber}</td>
          <td>${rep.yesSolvedNumber}</td>
        </tr>
      </c:forEach>
      </tbody>
    </table>
   <%-- <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/property/RepairStatistics.html?pageIndex={0}&propertyArea=${propertyCompanySearch.propertyArea}&companyName=${propertyCompanySearch.companyName}&propertyProject=${propertyCompanySearch.propertyProject}&projectAdmin${propertyCompanySearch.projectAdmin}"/>--%>
  </div>
