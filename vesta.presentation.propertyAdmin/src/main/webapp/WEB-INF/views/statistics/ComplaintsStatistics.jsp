...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../statistics/ComplaintsStatistics.html">
  ...
  <div class="table-responsive bs-example widget-shadow">
    <table width="100%" class="tableStyle">
      <thead>
      <tr>
        <th><spring:message code="propertyCompany.serialNumber" /></th>
        <th><spring:message code="propertyCompany.propertyProject" /></th>
        <th><spring:message code="statistics.complaintsNumber" /></th>
        <th><spring:message code="statistics.feedbackNumber" /></th>
      </tr>
      </thead>
      <tbody>
      <c:forEach items="${complaints}" var="comp" varStatus="row">
        <tr>
          <td><b>${row.index + 1}</b></td>
          <td>${comp.projectName}</td>
          <td>${comp.complaintsNumber}</td>
          <td>${comp.feedbackNumber}</td>
        </tr>
      </c:forEach>
      </tbody>
    </table>
   <%-- <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/property/ComplaintsStatistics.html?pageIndex={0}&propertyArea=${propertyCompanySearch.propertyArea}&companyName=${propertyCompanySearch.companyName}&propertyProject=${propertyCompanySearch.propertyProject}&projectAdmin${propertyCompanySearch.projectAdmin}"/>--%>
  </div>
