...
<div class="main-content">
  ...
  <div class="forms">
    ...
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form  action="../click/ClickTimes.html" method="post">
  ...
  <div class="table-responsive bs-example widget-shadow">
    <table width="100%" class="tableStyle">
      ...
      <tr>
        ...
        <th><spring:message code="clickTimes.statisticsPage" /></th>
        <th><spring:message code="clickTimes.statisticsCircle" /></th>
        <th><spring:message code="clickTimes.statisticsService" /></th>
        <th><spring:message code="clickTimes.statisticsPeriphery" /></th>
        <th><spring:message code="clickTimes.statisticsHome" /></th>
      </tr>
      </thead>
      <tbody>
      <c:forEach items="${ClickTimesList}" var="click" varStatus="row">
        <tr>
          <td><b>${row.index + 1}</b></td>
            <td>${click.project}</td>
            <td><a href="../click/ClickTimesPage.html?projectId=${click.projectId}" >${click.total}</a></td>
            <td>${click.circle}</td>
            <td>${click.service}</td>
            <td>${click.periphery}</td>
            <td>${click.home}</td>
        </tr>
      </c:forEach>
      </tbody>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/click/ClickTimes.html?pageIndex={0}&propertyProject=${clickTimesSeachDTO.propertyProject}&companyName=${clickTimesSeachDTO.companyName}&propertyArea=${clickTimesSeachDTO.propertyArea}"/>
  </div>
