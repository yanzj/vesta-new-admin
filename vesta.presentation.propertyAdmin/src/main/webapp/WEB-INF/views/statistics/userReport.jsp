...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form:form class="form-horizontal" action="../click/userReport.html" modelAttribute="userSearch"
                   method="get">
          <div class="form-group  col-xs-5">
            ...
            <div class="input-group date form_date col-sm-8" data-date="" data-date-format="yyyy-mm-dd"
              ...
              <form:input type="text" class="form-control" placeholder="请输入统计开始时间" path="startTime"
                          value="${userSearch.startTime}" readonly="true"/>
          ...
          <div class="form-group  col-xs-5">
            ...
            <div class="input-group date form_date col-sm-8" data-date="" data-date-format="yyyy-mm-dd"
              ...
              <form:input type="text" class="form-control" placeholder="请输入统计结束时间" path="endTime"
                          value="${userSearch.endTime}" readonly="true"/>
              <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
              <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
            </div>
          </div>
  ...
  <div class="table-responsive bs-example widget-shadow">
    ...
    <table width="100%" class="tableStyle table-striped">
      ...
      <tr>
        ...
        <th><spring:message code="clickTimes.commonUser"/></th>
        <th><spring:message code="clickTimes.ownerUser"/></th>
        <th><spring:message code="clickTimes.android"/></th>
        <th><spring:message code="clickTimes.ios"/></th>
        <th><spring:message code="clickTimes.weChat"/></th>
        <%--<th><spring:message code="clickTimes.male" /></th>--%>
        <%--<th><spring:message code="clickTimes.female" /></th>--%>
        <th><spring:message code="clickTimes.userTotal"/></th>
      </tr>
      </thead>
      <tbody>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/click/userReport.html?pageIndex={0}&startTime=${userSearch.startTime}&endTime=${userSearch.endTime}"/>
  </div>
</div>
</div>
</div>
...
<script type="text/javascript">
  ...
  var startTime = "${userSearch.startTime}";
  var endTime = "${userSearch.endTime}";
</script>
...
<script type="text/javascript">
  ...
  function isExcel() {
    var size = $("#size").val();
    if (size > 0) {
      var href = "../click/exportExcel?type=1&pageIndex={0}&startTime=${userSearch.startTime}&endTime=${userSearch.endTime}";
