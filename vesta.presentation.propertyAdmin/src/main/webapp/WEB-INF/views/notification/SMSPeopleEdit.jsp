...
<script>
  function validate() {
    ...
    var check = /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/;
    ...
    <div class="widget-shadow " data-example-id="basic-forms">
      ...
      <div class="form-body">
        ...
        <div class="form-body" style="min-height:1500px">
          <form class="form-horizontal" id="frm" action="../smsMessage/smsPeopleUpdate" method="post">
                ...
                <select id="cityNum" name="cityNum" class="form-control" onchange="queryProjectNameById()">
                  ...
                  <c:forEach items="${city}" var="item" >
                    <option value="${item.cityId }"
                            <c:if test="${item.cityId eq people.city}">selected</c:if>
            ...
            <div class="form-group col-lg-10">
              ...
              <div class="col-sm-5">
                <textarea class="form-control" name="cityList" id="cityList" readonly style="width: 432px; height: 71px;"><c:if test="${allCityInScope != ''}">${allCityInScope }</c:if><c:if test="${allCityInScope == ''}">${cityInScope }</c:if></textarea>
            ...
            <div class="form-group  col-lg-10">
              ...
              <div class="col-sm-5">
                <select id="projectNum" name="projectNum" class="form-control">
                  ...
                  <option value="${people.projectNum}">${people.scope}</option>
                </select>
              </div>
              <div class="col-sm-2">
                ...
                <select id="model" name="model" class="form-control" onchange="queryProjectNameById()">
                  <c:forEach items="${alertsModel}" var="item" >
                    <option value="${item.key }"
                            <c:if test="${item.value eq people.model}">selected</c:if>>${item.value }</option>
                  </c:forEach>
                </select>
              </div>
              <div class="col-sm-2">
            ...
            <div class="form-group col-lg-10">
              ...
              <div class="col-sm-5">
                                <textarea class="form-control" name="modelList" id="modelList" readonly
                                          style="width: 432px; height: 71px;" ></textarea>
              </div>

            </div>

            <div class="text-center form-group  col-lg-9" style="padding:0;">
