...
<div>
    ...
    <div class="container1 userStaffManage">
        <form class="form-horizontal" name="projectInfo" id="projectInfo" action="../securityProject/saveGroupRole.html">
            <div class="row">
                <div class="col-md-10 " style=" border-bottom: 1px dashed #ccc;">
                    <%--<span style="line-height: 30px;font-size: 15px;">编辑集团</span>--%>
            ...
            <div style="line-height: 30px;margin-top: 15px;">
                ...
                <span class="role_table_fillCont">
                    <input type="text" class="roleNameText" name="groupName" autofocus="autofocus"
            ...
            <div class="row">
                <div class="col-md-10 role_new_submit2">
                    <table class="table table-bordered">
                        <input type="hidden" name="groupId" value="${securityAllRoleDTO.id}">
                        <tbody>
                        <tr style="background-color: #003366;color: #fff;">
                            <td colspan="2">安全集团管理功能权限相关信息</td>
                        </tr>
                        <tr>
                            <td class="role_table_roleName"><span>HSE部门</span></td>
                            <td>
                                <input type="hidden" name="groupDept" id="viewAgencys">
                                <input type="hidden" name="groupStaff" id="viewStaffs">
                                <div class="existence">
                                          <span style="display:inline-block" class="selectResult" id="role_linkRole">
                                            <c:if test="${(securityAllRoleDTO.groupDep) != null && fn:length(securityAllRoleDTO.groupDep)>0}">
                                                <c:forEach items="${securityAllRoleDTO.groupDep}" var="dept">
                                                    ${dept.name}；
                                                </c:forEach>
                                                <br/>
                                            </c:if>
                                              <c:if test="${securityAllRoleDTO.groupStaff != null && fn:length(securityAllRoleDTO.groupStaff)>0}">
                                                  <c:forEach items="${securityAllRoleDTO.groupStaff}" var="staff">
                                                      ${staff.name}；
                                                  </c:forEach>
                                              </c:if>
                                          </span>
