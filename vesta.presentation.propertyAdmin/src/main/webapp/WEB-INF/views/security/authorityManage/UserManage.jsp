...
<div class="main-content">
    ...
    <div style="text-align: right; margin-top: 8px; margin-right: 25px;">
        ...
        <c:if test="${function.sth40020007 eq 'Y'}">
        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                <form class="form-horizontal" name="searchByName" id="searchByName"
                      action="../authority/conditionQueryUser.html">
                    <%-- 所属机构--%>
        ...
        <div class="row">
            ...
            <div class="table-responsive widget-shadow col-md-9" style="float:left;margin-top:0">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" onclick="toHandle('${list.staffIdB}','${list.isEnabledB}')" id="toHandle"
                                   class="a3">
                                    <c:if test="${list.isEnabledB eq '0' and function.sth40020005 eq 'Y'}">启用
                                    </c:if>
                                    <c:if test="${list.isEnabledB eq '1' and function.sth40020006 eq 'Y'}">停用
                                    </c:if>
                                </a>
                            </td>
                        </tr>
                ...
                <m:pager pageIndex="${webPage.pageIndex}"
                         ...
                         submitUrl="${pageContext.request.contextPath }../authority/conditionQueryUser.html?pageIndex={0}&agencyIdB=${userStaffDTO.agencyIdB}&agencyNameB=${userStaffDTO.agencyNameB}&staffNameB=${userStaffDTO.staffNameB}&userNameB=${userStaffDTO.userNameB}&isEnabledB=${userStaffDTO.isEnabledB}&mobileB=${userStaffDTO.mobileB}&emailB=${userStaffDTO.emailB}"/>
            </div>
        </div>
    </div>
        ...
        if(confirm('数据更新时间较长,确认更新么？')){
            $.ajax({
                ...
                success:function(json){
                    ...
                    if(code == 0){
                        alert("更新成功！");
                        window.parent.location.href="/authority/initUserManage.html";
                    }else if(code == 1){
                        alert("更新失败！");
                        window.parent.location.href="/authority/initUserManage.html";
                    }
...
//        saveOpenTreeData(treeNode);
        window.location.href = "../authority/conditionQueryUser.html?agencyIdB=" + treeNode.id ;
    }
    ...
    $(document).ready(function () {
        $.ajax({
            url: "../authority/getAllAgency", dataType: "json", success: function (result) {
