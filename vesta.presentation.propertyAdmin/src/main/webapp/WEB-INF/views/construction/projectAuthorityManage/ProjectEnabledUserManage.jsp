        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                <form class="form-horizontal" name="searchByName" id="searchByName"
                      action="../authorityForProject/getProjectEnabledUser.html">
                    <%--所属机构--%>
        ...
        <div class="row">
            <div class="table-responsive bs-example widget-shadow">
                ...
                <m:pager pageIndex="${webPage.pageIndex}"
                         ...
                         submitUrl="${pageContext.request.contextPath }../authorityForProject/getProjectEnabledUser.html?pageIndex={0}&agencyNameE=${enabledUserDTO.agencyNameE}&staffNameE=${enabledUserDTO.staffNameE}&userNameE=${enabledUserDTO.userNameE}&sourceFromE=${enabledUserDTO.sourceFromE}&mobileE=${enabledUserDTO.mobileE}&emailE=${enabledUserDTO.emailE}"/>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    function isExcel(){
        var size = $("#size").val();
        if(size>0){
            var href = "../authorityForProject/enabledUserExportExcel?agencyNameE=${enabledUserDTO.agencyNameE}&staffNameE=${enabledUserDTO.staffNameE}&userNameE=${enabledUserDTO.userNameE}&sourceFromE=${enabledUserDTO.sourceFromE}&mobileE=${enabledUserDTO.mobileE}&emailE=${enabledUserDTO.emailE}";
