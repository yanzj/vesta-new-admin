...
<script type="text/javascript">
    $.validator.setDefaults({
        submitHandler: function() {
            ...
            if(reg.test(mobile)){
                $.ajax({
                    url: "../authorityForProject/addOrUpdateOuterUser",            //目标网址
                    type: "post",
                    async: "false",
                    dataType: "json",
                    ...
                    success: function (json) {
                        ...
                        if (code != 0) {
                            ...
                            if (data == 'ok') {
                                alert("保存成功");
                                window.location.href = '../authorityForProject/outerProjectUserManage.html?agencyId='+$("#agencyId").val();
                            } else {
                                alert(data);
                            }
                        }
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $.ajax({
            url: "../authorityForProject/getProjectOuterAgencyByStaffId",
            dataType: "json",
            data:{
