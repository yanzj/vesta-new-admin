...
<head>
    ...
    <script>
        $(function(){
            console.log("sqq")
            $("#007300060000").addClass("active");
            $("#007300060000").parent().parent().addClass("in");
            $("#007300060000").parent().parent().parent().parent().addClass("active");
        })
        new WOW().init();
    </script>
    <!--//end-animate-->
...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="007300060000" username="${authPropertystaff.staffName}"/>
        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                <form class="form-horizontal" name="searchByName" id="searchByName"
                      action="../clientAccredit/initClientUserAccreditManage.html">
                    <%--人员姓名--%>
                    ...
                    <div class="form-group  col-lg-4" style="height: 30px;">
                        ...
                        <div style="text-align: center; margin-top: 8px;">
                            <c:if test="${function.qch40010117 eq 'Y'}">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${list.updateFunction eq 'Y'}">
                                    <a style="cursor: pointer" href="../clientAccredit/userClientAccreditBatch.html?staffIdA=${list.staffIdA}&staffNameA=${list.staffNameA}" class="a3"><span class="span1">修改</span></a>
                                </c:if>
                                <c:if test="${list.delFunction eq 'Y'}">
                                    <a style="cursor: pointer" href="../clientAccredit/deleteClientAccredit.html?peojectRoleUserIdA=${list.peojectRoleUserIdA}&agencyIdA=${accreditManageDTO.agencyIdA}&staffNameA=${accreditManageDTO.staffNameA}&userNameA=${accreditManageDTO.userNameA}&sysNameA=${accreditManageDTO.sysNameA}&roleNameA=${accreditManageDTO.roleNameA}&projectNameA=${accreditManageDTO.projectNameA}" class="a3"><span class="span1">删除</span></a>
                                </c:if>
                                </a>
                            </td>
                        </tr>
            ...
            <div class="modal-body"     style="height: auto; min-height: 650px;">
                ...
                <div class="container" style="width: 420px; float: left">
                    ...
                    <div class=" col-md-12 moveBtn" style="margin-top: 3.1%;text-align: center;">
                        ...
                        <form class="submitForm" id="form2" name="form2" method="post" action="../clientAccredit/saveUserRoleRelation_2">
...
//                $.fn.zTree.init($("#treeDemo"), setting,result);
    ...
    function onClick1(event, treeId, treeNode, clickFlag) {
        window.location.href = "../clientAccredit/initClientUserAccreditManage.html?agencyIdA=" + treeNode.id ;
    }
