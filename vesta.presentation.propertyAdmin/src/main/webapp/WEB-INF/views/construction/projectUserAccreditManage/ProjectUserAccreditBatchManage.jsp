...
<head>
    ...
    <script>
        $(function(){
            console.log("sqq")
            $("#007100050000").addClass("active");
            $("#007100050000").parent().parent().addClass("in");
            $("#007100050000").parent().parent().parent().parent().addClass("active");
        })
        new WOW().init();
    </script>
    <!--//end-animate-->
...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="007100050000" username="${authPropertystaff.staffName}"/>
</div>
...
<script type="text/javascript">
    ...
    $('.serach_project').bind('click', function () {
        ...
        $.ajax({
            url: '/projectAccredit/getOwnerRoleByNameAndProjectId',
            data: {
...
//        arrData2select(arr2, '#right2');
    ...
    $(document).ready(function(){
        $.ajax({
            url: "../projectAccredit/getOAAgencyMessageProject",
            dataType: "json",
            async: false,
            cache: false,
            success: function (result) {
...
//                $.fn.zTree.init($("#treeDemo"), setting,result);
    ...
    function onClick2(event, treeId, treeNode, clickFlag) {
        ...
        var leftId = '#left2'
        //是最后一个  找后台要下一级
        $.getJSON('/projectAccredit/getOwnerRoleByAgencyId?id=' + treeNode.id , function (res) {
            childrenArr = res.data;
...
//            document.getElementById("form2").submit();
            ...
            $.ajax({
                url: "../projectAccredit/saveUserRoleRelation_2",            //目标网址
                type: "post",
                async: false,
                dataType: "json",
                ...
                success: function (json) {
                    ...
                    if (code != 0) {
                        ...
                        if (data == 'ok') {
                            ...
                            window.location.href = '../projectAccredit/projectStaffAccreditBatch.html';
                        } else {
                            alert(data);
                        }
                    }
