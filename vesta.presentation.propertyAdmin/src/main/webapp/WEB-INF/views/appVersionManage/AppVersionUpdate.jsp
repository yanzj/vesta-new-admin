...
<div class="main-content">
    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <%--搜索条件开始--%>
            <div class="form-body">
                <form class="form-horizontal" action="../qualityAPPVersionManagement/versionUpdate">
                    <%--版本id--%>
                    ...
                    <div class="form-group  col-lg-6">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" placeholder="" id="appEdition" name="appEdition">
                                <c:if test="${appVersionDTO.appEdition eq '1'}">
                                    <option value="1" selected="selected"><spring:message
                                            code="AppVersion_Deliver"/></option>
                                </c:if>
                                <c:if test="${appVersionDTO.appEdition eq '2'}">
                                    <option value="2" selected="selected"><spring:message
                                            code="AppVersion_Engineering"/></option>
                                </c:if>
                                <c:if test="${appVersionDTO.appEdition eq '3'}">
                                    <option value="3" selected="selected"><spring:message
                                            code="AppVersion_Security"/></option>
                                </c:if>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" placeholder="" id="appVersionType" name="appVersionType">
                                <c:if test="${appVersionDTO.appVersionType eq '1'}">
                                    <option value="1" selected="selected"><spring:message
                                            code="AppVersion_IOS"/></option>
                                </c:if>
                                <c:if test="${appVersionDTO.appVersionType eq '2'}">
                                    <option value="2" selected="selected"><spring:message
                                            code="AppVersion_Android"/></option>
                                </c:if>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group  col-lg-6">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="" id="createBy" name="createBy"
                                   value="${appVersionDTO.createBy}" readonly>
                        </div>
                    </div>
                    <%--发布日期--%>
                    <div class="form-group  col-lg-6">
                    ...
                    <%--修改人--%>
                    <div class="form-group  col-lg-6">
                        <label for="modifyBy" class="col-sm-4 control-label"><spring:message
                                code="AppVersion_modifyBy"/>：</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="" id="modifyBy" name="modifyBy"
                                   value="${appVersionDTO.modifyBy}">
                        </div>
                    </div>
                    <%--修改时间--%>
                    <div class="form-group  col-lg-6">
                        <label for="modifyOn" class="col-sm-4 control-label"><spring:message
                                code="AppVersion_modifyOn"/>：</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="" id="modifyOn" name="modifyOn"
                                   value="${appVersionDTO.modifyOn}" readonly>
                        </div>
                    </div>
                    <%--下载地址--%>
                    <div class="form-group  col-lg-6">
                    ...
                    <div class="form-group  col-lg-6">
                        ...
                        <div class="form-control"
                            ...
                            <input type="radio" name="appVersionStatus" id="appVersionStatus_yes" value="2"
                                   <c:if test="${appVersionDTO.appVersionStatus eq '2'}">checked="checked"</c:if>><spring:message
                                code="AppVersion_status_YES"/>
                            <input type="radio" name="appVersionStatus" id="appVersionStatus_no" value="1"
                                   <c:if test="${appVersionDTO.appVersionStatus eq '1'}">checked="checked"</c:if>><spring:message
                                code="AppVersion_status_NO"/>
                        </div>
                    </div>
                    <%--文件大小--%>
                    <div class="form-group  col-lg-6">
                    ...
                    <div class="form-group  col-lg-6">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" content="${appVersionDTO.appRemark}" placeholder=""
                                      id="appRemark" name="appRemark"
                                      style="width:340px;height:77px;">${appVersionDTO.appRemark}</textarea>
                        </div>
                    </div>
                    <%--用户类型--%>
                    ...
                    <div class="text-center">
                        <c:if test="${function.qch40010082 eq 'Y'}">
                            <button type="submit" class="btn btn-primary" for="propertySearch"
                                    onclick="return testVersionUpdate()"><spring:message
