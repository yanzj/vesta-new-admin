        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                ...
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="frm" action="../communityArea/updateBatchManage"
                        ...
                        <div class="form-group  col-lg-6">
                            ...
                            <div class="col-sm-9">
                                <select id="communityName" name="communityName" class="form-control" value="${batchManage.communityName}">
                                    <c:forEach items="${communityAppointPageMapDto.projectNameMap}" var="item">
                                        <option value="${item.value }"
                                                <c:if test="${item.value eq batchManage.communityName}">selected</c:if>>
                                                ${item.value }
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="description" id="description"  style="width: 763px; height: 71px;">${batchManage.description}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group date form_date col-sm-8" data-date=""
                                ...
                                <input type="text" class="form-control" placeholder="" id="payStaDate" value="${batchManage.payStaDate}"
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="input-group date form_date col-sm-8" data-date="" data-date-format="yyyy-mm-dd"
                                ...
                                <input type="text" class="form-control" placeholder="" id="payEndDate" value="${batchManage.payEndDate}"
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="deliveryBatch"
                                       name="deliveryBatch" value="${batchManage.deliveryBatch}">
                            </div>
                        </div>
                        <div class='clearfix'> </div>
                        <%--报名人数上限--%>
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-sm-9" style="padding-top:7px;">
                                <input type="text" class="form-control" placeholder="" id="maxUser" name="maxUser"
                                       value="${batchManage.maxUser}">
                            </div>
                        </div>
                        <div class='clearfix'> </div>

                        <input type="hidden" name="id" id="id" value="${batchManage.id}">
