...
<div>
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="007000040000" username="${authPropertystaff.staffName}"/>
    <div class="container1 userStaffManage">
        <form class="form-horizontal" name="projectInfo" id="projectInfo"
              action="/authAgency/saveUserRoleRelation">
            <div class="row">
                <div class="col-md-10 " style=" border-bottom: 1px dashed #ccc;">
                    <div class="newRoleSubmit">
                        ...
                        <button onclick="javascript:history.go(-1);" class="btn btn-primary">关闭</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-10 role_new_submit2">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="authStaffId" id="authStaffs" ><!-- 人-->
                                <div class="existence">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="authRoleIds" id="authRoles" value="${authRoleId}"><!--角色-->
                                <div class="existence">
                                ...
                                <form class="submitForm" id="form1" name="form" method="post" action="">
                                    <table class="table">
                                        ...
                                        <select id="right" multiple="multiple">
                                            <c:forEach items="${adminDTO.list}" var="staff">
