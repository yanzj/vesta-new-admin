        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                <form class="form-horizontal" name="searchByName" id="searchByName"
                      action="../userAccredit/initUserAccreditManage.html">
                    <%--&lt;%&ndash;项目层级&ndash;%&gt;--%>
                    <%--<div class="form-group  col-lg-4">--%>
                        <%--<label for="agencyName" class="col-sm-4 control-label">项目层级</label>--%>
                        <%--<div class="col-sm-8">--%>
                            <%--<input type="text" class="form-control" placeholder="" id="agencyName"--%>
                                   <%--name="agencyName" value="${accreditManageDTO.agencyName}">--%>
                        <%--</div>--%>
                    <%--</div>--%>
                    <%--人员姓名--%>
                    <div class="form-group  col-lg-4">
                    ...
                    <div class="form-group  col-lg-4" style="height: 30px;">
                        ...
                        <div style="text-align: center; margin-top: 8px;">
                            <c:if test="${function.sth40020024 eq 'Y'}">
                                <button type="submit" id="sbm" class="btn btn-primary" for="propertySearch">查询</button>
                            </c:if>
                            <%--<c:if test="${function.sth40020025 eq 'Y'}">--%>
                                <%--&lt;%&ndash;<a href="../userAccredit/userAccreditBatch.html" class="btn btn-primary" >批量授权</a>&ndash;%&gt;--%>
                                <%--<span class="role_select btn btn-primary" data-toggle="modal" data-target="#myModal1">批量授权</span>--%>
                            <%--</c:if>--%>
                        </div>
                </form>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${list.updateFunction eq 'Y'}">
                                    <a style="cursor: pointer" href="../userAccredit/userAccreditBatch.html?staffIdA=${list.staffIdA}&staffNameA=${list.staffNameA}" class="a3"><span class="span1">修改</span></a>
                                </c:if>
                                <c:if test="${list.delFunction eq 'Y'}">
                                    <a style="cursor: pointer" href="../userAccredit/deleteAccredit.html?peojectRoleUserIdA=${list.peojectRoleUserIdA}&agencyIdA=${accreditManageDTO.agencyIdA}&staffNameA=${accreditManageDTO.staffNameA}&userNameA=${accreditManageDTO.userNameA}&sysNameA=${accreditManageDTO.sysNameA}&roleNameA=${accreditManageDTO.roleNameA}&projectNameA=${accreditManageDTO.projectNameA}" class="a3"><span class="span1">删除</span></a>
                                </c:if>
                                </a>
                            </td>
                        </tr>
            ...
            <div class="modal-body"     style="height: auto; min-height: 650px;">
                ...
                <div class="container" style="width: 420px; float: left">
                    ...
                    <div class=" col-md-12 moveBtn" style="margin-top: 3.1%;text-align: center;">
                        ...
                        <form class="submitForm" id="form2" name="form2" method="post" action="../userAccredit/saveUserRoleRelation_2">
...
//        arrData2select(arr2, '#right2');
    ...
    $(document).ready(function(){
        $.ajax({
//            url: "../userAccredit/getAllAgencyManage",
...
//                $.fn.zTree.init($("#treeDemo"), setting,result);
    ...
    function onClick1(event, treeId, treeNode, clickFlag) {
        window.location.href = "../userAccredit/initUserAccreditManage.html?agencyIdA=" + treeNode.id ;
    }
