...
<head>
    ...
    <script>
        $(function(){
            console.log("sqq")
            $("#007000050000").addClass("active");
            $("#007000050000").parent().parent().addClass("in");
            $("#007000050000").parent().parent().parent().parent().addClass("active");
        })
        new WOW().init();
    </script>
    <!--//end-animate-->
...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="007000050000" username="${authPropertystaff.staffName}"/>
</div>
...
//            document.getElementById("form2").submit();
            ...
            $.ajax({
                url: "../userAccredit/saveUserRoleRelation_2",            //目标网址
                type: "post",
                async: false,
                dataType: "json",
                ...
                success: function (json) {
                    ...
                    if (code != 0) {
                        ...
                        if (data == 'ok') {
                            ...
                            window.location.href = '../userAccredit/staffAccreditBatch.html';
                        } else {
                            alert(data);
                        }
                    }
