...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="001500010000" username="${propertystaff.staffName}"/>
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                ...
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="frm" action="../housetype/houseTypeSave" method="post"
                        ...
                        <div class="form-group col-lg-8">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="comments"
                                          name="comments">${houseType.comments}</textarea>
                            </div>
                        </div>
                        <%--问题状态 --%>
                        <div class="form-group col-lg-8">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" placeholder="" id="type" name="type">
                                    ...
                                    <option value="100000000">户型图
                                    </option>
                                    <option value="100000001">楼栋公共区域
                                    </option>
                                    <option value="100000002">项目公共区域
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="text-center form-group  col-lg-10" style="padding:0;">
                            <c:if test="${function.qch40010058 eq 'Y'}">
