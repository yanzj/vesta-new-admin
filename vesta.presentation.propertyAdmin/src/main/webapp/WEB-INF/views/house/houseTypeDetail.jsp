                    ...
                    <form class="form-horizontal" id="frm" action="../housetype/saveUpdate" method="post"
                        ...
                        <div class="form-group col-lg-8">
                            <label class="col-sm-3 control-label" for="projectName"><spring:message
                                    code="rental.project"/></label>

                            <div class="col-sm-9">
                                <textarea class="form-control" id="projectName" name="projectName" readonly>${houseType.projectName}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="text-center form-group  col-lg-10" style="padding:0;">
                            <a type="button" class="btn btn-primary" href="../housetype/houseTypeManage.html"><spring:message
                                    code="common_back"/></a>
                        </div>
