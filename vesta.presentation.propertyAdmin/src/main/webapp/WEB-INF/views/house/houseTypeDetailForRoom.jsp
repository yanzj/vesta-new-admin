...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001500020000" username="${propertystaff.staffName}"/>
    <div class="forms">
                ...
                <div class="form-body" style="min-height:380px">
                    <form class="form-horizontal" id="frm" action="../housetype/saveUpdate" method="post"
                        ...
                        <div class="form-group col-lg-8">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="" id="name" name="name" value="${houseType.name}" readonly>
                            </div>
                        </div>
                        <%--描述--%>
                        <div class="form-group col-lg-8">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="comments" name="comments" readonly>${houseType.comments}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="text-center form-group  col-lg-10" style="padding:0;">
                            <button type="button" class="btn btn-primary" onclick="toback()"><spring:message
...
<script>
    ...
    function toback(){
        var url="../houseroomtype/houseRoomTypeManage.html?cityId=${typeSearch.cityId}&projectId=${typeSearch.projectNum}&areaId=${typeSearch.areaId}&buildingId=${typeSearch.buildingNum}&unitId=${typeSearch.unitNum}";
        url = url.replace(/#/g,"@$@");
