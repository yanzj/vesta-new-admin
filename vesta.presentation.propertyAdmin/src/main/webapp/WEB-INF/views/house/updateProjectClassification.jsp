            ...
            <div class="row">
                <div class="col-md-10 role_new_submit2">
                    <table class="table table-bordered">
                        ...
                        <!-- 仅查看该项目下交验房整改单与验房单权限 不能对单据进行操作  后台接口查询所有数据-->
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="Repair1ObjectiveStaffs" id="Repair1ObjectiveStaffs">
                                <input type="hidden" name="Repair1ObjectiveAgencys" id="Repair1ObjectiveAgencys">
                                <input type="hidden" name="Repair1ObjectiveOrganizes" id="Repair1ObjectiveOrganizes">
                                ...
                                <span class="role_select" data-toggle="modal" data-target="#Repair1">选择</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="ReceptionObjectiveStaffs" id="ReceptionObjectiveStaffs">
                                <input type="hidden" name="ReceptionObjectiveAgencys" id="ReceptionObjectiveAgencys">
                                <input type="hidden" name="ReceptionObjectiveOrganizes" id="ReceptionObjectiveOrganizes">
                                <!-- <span class="existence" ></span> -->
                                <div class="existence">
                                ...
                                <span class="role_select" data-toggle="modal" data-target="#Reception">选择</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="ComplaintObjectiveStaffs" id="ComplaintObjectiveStaffs">
                                <input type="hidden" name="ComplaintObjectiveAgencys" id="ComplaintObjectiveAgencys">
                                <input type="hidden" name="ComplaintObjectiveOrganizes" id="ComplaintObjectiveOrganizes">
                                <!-- <span class="existence" ></span> -->
                                <div class="existence">
                                ...
                                <span class="role_select" data-toggle="modal" data-target="#Complaint">选择</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="ComplaintsButtStaffsss" id="ComplaintsButtStaffsss">
                                <input type="hidden" name="ComplaintsButtAgencysss" id="ComplaintsButtAgencysss">
                                <input type="hidden" name="ComplaintsButtOrganizesss" id="ComplaintsButtOrganizesss">
                                <!-- <span class="existence" ></span> -->
                                <div class="existence">
...
<%--报修：数据查看   模态框--%>
<div class="modal fade" id="Repair1" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="container">
                    <div class="containerSelect1">
                        <div class="row" style="border-bottom: 1px solid #ccc;margin-bottom: 40px;">
                            <div class="col-md-4 typeList" style="padding-left: 0;">
                                <div class="typeList_departmentRepair1" style="color: #fff;background: #0D165E">部门
                                </div>
                                <div class="typeList_employeesRepair1">员工</div>
                                <div class="typeList_groupRepair1">群组</div>
                            </div>

                        </div>
                        <div class="row ">
                            <div class="content_wrap6 col-md-3">
                                <div class="zTreeDemoBackgroundRepair1 left" style="border: 1px solid #ccc;">
                                    <ul id="treeDemoRepair1" class="ztree"></ul>
                                </div>
                                <div class="people_listRepair1"></div>
                                <div class="group_listRepair1"></div>
                            </div>
                            <div class="col-md-5 addPeopleRepair1" style="left: 7%;">
                                <input type="text" class="serach_people_keyRepair1" placeholder="关键字添加员工" value="">
                                <button type="submit" class="serach_peopleRepair1">搜索</button>
                            </div>
                            <div class="col-md-3 departmentRepair1 waitSelect">
                                <h5>待选列表</h5>
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <select id="leftRepair1" multiple="multiple">
                                        </select>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnRRepair1">添加<</button>
                                </div>
                            </div>
                            <div class="col-md-3 departmentRepair1">
                                <h5 class="h52">已选列表</h5>
                                <form class="submitForm" id="formRepair1" name="form" method="post" action="">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <select id="rightRepair1" multiple="multiple">
                                                <c:forEach items="${Repair1Objective}" var="objective">
                                                    <c:if test="${objective.agencyType eq 1}">
                                                        <option class="htmlDepartmentRepair1"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 2}">
                                                        <option class="htmlGroupRepair1"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 3}">
                                                        <option class="htmlPersonRepair1"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnDRepair1">移除</button>
                                </div>
                            </div>
                        </div>
                        <div class="btnB"></div>
                        <div class=" col-md-offset-5" style="display: block;margin-top: 30px;">
                            <button type="submit" class="confirmRepair1" class="close" data-dismiss="modal"
                                    aria-hidden="true">确认
                            </button>
                            <button class="cancel" data-dismiss="modal">取消</button>
                        </div>
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="containerSelect1">
                        <div class="row" style="border-bottom: 1px solid #ccc;margin-bottom: 40px;">
                            <div class="col-md-4 typeList" style="padding-left: 0;">
                                <div class="typeList_departmentComplaint" style="color: #fff;background: #0D165E">部门
                                </div>
                                <div class="typeList_employeesComplaint">员工</div>
                                <div class="typeList_groupComplaint">群组</div>
                            </div>

                        </div>
                        <div class="row ">
                            <div class="content_wrap6 col-md-3">
                                <div class="zTreeDemoBackgroundComplaint left" style="border: 1px solid #ccc;">
                                    <ul id="treeDemoComplaint" class="ztree"></ul>
                                </div>
                                <div class="people_listComplaint"></div>
                                <div class="group_listComplaint"></div>
                            </div>
                            <div class="col-md-5 addPeopleComplaint" style="left: 7%;">
                                <input type="text" class="serach_people_keyComplaint" placeholder="关键字添加员工" value="">
                                <button type="submit" class="serach_peopleComplaint">搜索</button>
                            </div>
                            <div class="col-md-3 departmentComplaint waitSelect">
                                <h5>待选列表</h5>
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <select id="leftComplaint" multiple="multiple">
                                        </select>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnRComplaint">添加<</button>
                                </div>
                            </div>
                            <div class="col-md-3 departmentComplaint">
                                <h5 class="h52">已选列表</h5>
                                <form class="submitForm" id="formComplaint" name="form" method="post" action="">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <select id="rightComplaint" multiple="multiple">
                                                <c:forEach items="${ComplaintObjective}" var="objective">
                                                    <c:if test="${objective.agencyType eq 1}">
                                                        <option class="htmlDepartmentComplaint"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 2}">
                                                        <option class="htmlGroupComplaint"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 3}">
                                                        <option class="htmlPersonComplaint"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnDComplaint">移除</button>
                                </div>
                            </div>
                        </div>
                        <div class="btnB"></div>
                        <div class=" col-md-offset-5" style="display: block;margin-top: 30px;">
                            <button type="submit" class="confirmComplaint" class="close" data-dismiss="modal"
                                    aria-hidden="true">确认
                            </button>
                            <button class="cancel" data-dismiss="modal">取消</button>
                        </div>
...
<%--投诉：项目前台   模态框--%>
<div class="modal fade" id="Reception" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="container">
                    <div class="containerSelect1">
                        <div class="row" style="border-bottom: 1px solid #ccc;margin-bottom: 40px;">
                            <div class="col-md-4 typeList" style="padding-left: 0;">
                                <div class="typeList_departmentReception" style="color: #fff;background: #0D165E">部门
                                </div>
                                <div class="typeList_employeesReception">员工</div>
                                <div class="typeList_groupReception">群组</div>
                            </div>

                        </div>
                        <div class="row ">
                            <div class="content_wrap6 col-md-3">
                                <div class="zTreeDemoBackgroundReception left" style="border: 1px solid #ccc;">
                                    <ul id="treeDemoReception" class="ztree"></ul>
                                </div>
                                <div class="people_listReception"></div>
                                <div class="group_listReception"></div>
                            </div>
                            <div class="col-md-5 addPeopleReception" style="left: 7%;">
                                <input type="text" class="serach_people_keyReception" placeholder="关键字添加员工" value="">
                                <button type="submit" class="serach_peopleReception">搜索</button>
                            </div>
                            <div class="col-md-3 departmentReception waitSelect">
                                <h5>待选列表</h5>
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <select id="leftReception" multiple="multiple">
                                        </select>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnRReception">添加<</button>
                                </div>
                            </div>
                            <div class="col-md-3 departmentReception">
                                <h5 class="h52">已选列表</h5>
                                <form class="submitForm" id="formReception" name="form" method="post" action="">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <select id="rightReception" multiple="multiple">
                                                <c:forEach items="${ReceptionObjective}" var="objective">
                                                    <c:if test="${objective.agencyType eq 1}">
                                                        <option class="htmlDepartmentReception"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 2}">
                                                        <option class="htmlGroupReception"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                    <c:if test="${objective.agencyType eq 3}">
                                                        <option class="htmlPersonReception"
                                                                value="${objective.agencyId}">${objective.agencyName}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </select>
                                ...
                                <div class=" col-md-9 moveBtn5" style="margin-left: 20%;">
                                    <button id="btnDReception">移除</button>
                                </div>
                            </div>
                        </div>
                        <div class="btnB"></div>
                        <div class=" col-md-offset-5" style="display: block;margin-top: 30px;">
                            <button type="submit" class="confirmReception" class="close" data-dismiss="modal"
                                    aria-hidden="true">确认
                            </button>
                            <button class="cancel" data-dismiss="modal">取消</button>
                        </div>
...
<script>
    ...
    var selectedData = [], selectedData2 = [], selectedData3 = [], selectedData4 = [], selectedData5 = [],
        ...
        selecteHQ = [], selecteRepair1 = [],selecteComplaint = [],selecteReception = [];
    var sview = [], aview = [], oview = [], splum = [], aplum = [], opluum = [], spro = [], apro = [], opro = [],
        ...
        oHQ = [], sRepair1 = [], aRepair1 = [], oRepair1 = [], sComplaint = [], aComplaint = [], oComplaint = [],
        sReception = [], aReception = [], oReception = [];
    ...
    // 报修 数据查看 Dispatch
    $("#rightRepair1 option.htmlDepartmentRepair1").each(function (i) {
        if (this.value != "") {
            selecteRepair1.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 1 + '}'));
            aRepair1[i] = this.value;
        }
    });
    $("#rightRepair1 option.htmlPersonRepair1").each(function (i) {
        if (this.value != "") {
            selecteRepair1.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 3 + '}'));
            sRepair1[i] = this.value;
        }
    });
    $("#rightRepair1 option.htmlGroupRepair1").each(function (i) {
        if (this.value != "") {
            selecteRepair1.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 2 + '}'));
            oRepair1[i] = this.value;
        }
    });

    // 投诉 数据查看 Dispatch
    $("#rightComplaint option.htmlDepartmentComplaint").each(function (i) {
        if (this.value != "") {
            selecteComplaint.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 1 + '}'));
            aComplaint[i] = this.value;
        }
    });
    $("#rightComplaint option.htmlPersonComplaint").each(function (i) {
        if (this.value != "") {
            selecteComplaint.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 3 + '}'));
            sComplaint[i] = this.value;
        }
    });
    $("#rightComplaint option.htmlGroupComplaint").each(function (i) {
        if (this.value != "") {
            selecteComplaint.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 2 + '}'));
            oComplaint[i] = this.value;
        }
    });

    // 投诉 项目前台 Dispatch
    $("#rightReception option.htmlDepartmentReception").each(function (i) {
        if (this.value != "") {
            selecteReception.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 1 + '}'));
            aReception[i] = this.value;
        }
    });
    $("#rightReception option.htmlPersonReception").each(function (i) {
        if (this.value != "") {
            selecteReception.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 3 + '}'));
            sReception[i] = this.value;
        }
    });
    $("#rightReception option.htmlGroupReception").each(function (i) {
        if (this.value != "") {
            selecteReception.push(JSON.parse('{"name":"' + this.innerHTML + '","id":"' + this.value + '","type":' + 2 + '}'));
            oReception[i] = this.value;
        }
    });
    ...
    //报修：数据查询
    arrDataRepair1select(selecteRepair1, '#rightRepair1')
    $('#Repair1ObjectiveStaffs').val(sRepair1.join());
    $('#Repair1ObjectiveAgencys').val(aRepair1.join());
    $('#Repair1ObjectiveOrganizes').val(oRepair1.join());

    //投诉：数据查询
    arrDataComplaintselect(selecteComplaint, '#rightComplaint')
    $('#ComplaintObjectiveStaffs').val(sComplaint.join());
    $('#ComplaintObjectiveAgencys').val(aComplaint.join());
    $('#ComplaintObjectiveOrganizes').val(oComplaint.join());

    //投诉：项目前台
    arrDataReceptionselect(selecteReception, '#rightReception')
    $('#ReceptionObjectiveStaffs').val(sReception.join());
    $('#ReceptionObjectiveAgencys').val(aReception.join());
    $('#ReceptionObjectiveOrganizes').val(oReception.join());
    ...
    //报修 数据查看
    $('.typeList_departmentRepair1').bind('click', function () {
        $('.group_listRepair1').css('display', 'none');
        $('.zTreeDemoBackgroundRepair1').css('display', 'block');
        $('#treeDemoRepair1').css('display', 'block');
        $('.departmentRepair1').css('margin-top', '-2.95%');
        $('.addPeopleRepair1').css('display', 'none');
        $('.moveBtnRepair1').css('margin-top', '3.1%');
        $('.content_wrapRepair1 .resultPeopleRepair1').css('display', 'none');
        $('.typeList_departmentRepair1').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesRepair1').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupRepair1').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftRepair1').html('');
    });

    //投诉 数据查看
    $('.typeList_departmentComplaint').bind('click', function () {
        $('.group_listComplaint').css('display', 'none');
        $('.zTreeDemoBackgroundComplaint').css('display', 'block');
        $('#treeDemoComplaint').css('display', 'block');
        $('.departmentComplaint').css('margin-top', '-2.95%');
        $('.addPeopleComplaint').css('display', 'none');
        $('.moveBtnComplaint').css('margin-top', '3.1%');
        $('.content_wrapComplaint .resultPeopleComplaint').css('display', 'none');
        $('.typeList_departmentComplaint').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesComplaint').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupComplaint').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftComplaint').html('');
    });

    //投诉 项目前台
    $('.typeList_departmentReception').bind('click', function () {
        $('.group_listReception').css('display', 'none');
        $('.zTreeDemoBackgroundReception').css('display', 'block');
        $('#treeDemoReception').css('display', 'block');
        $('.departmentReception').css('margin-top', '-2.95%');
        $('.addPeopleReception').css('display', 'none');
        $('.moveBtnReception').css('margin-top', '3.1%');
        $('.content_wrapReception .resultPeopleReception').css('display', 'none');
        $('.typeList_departmentReception').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesReception').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupReception').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftReception').html('');
    });
    ...
    //报修 ：数据查看
    $('.typeList_employeesRepair1').bind('click', function () {
        $('.group_listRepair1').css('display', 'none');
        $('.addPeopleRepair1').css('display', 'block');
        $('.departmentRepair1').css('margin-top', '-2.95%');
        $('.zTreeDemoBackgroundRepair1').css('display', 'none');
        $('.moveBtnRepair1').css('margin-top', '-1.54%');
        $('.typeList_employeesRepair1').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_departmentRepair1').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupRepair1').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftRepair1').html('');
    });

    //投诉 ：数据查看
    $('.typeList_employeesComplaint').bind('click', function () {
        $('.group_listComplaint').css('display', 'none');
        $('.addPeopleComplaint').css('display', 'block');
        $('.departmentComplaint').css('margin-top', '-2.95%');
        $('.zTreeDemoBackgroundComplaint').css('display', 'none');
        $('.moveBtnComplaint').css('margin-top', '-1.54%');
        $('.typeList_employeesComplaint').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_departmentComplaint').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupComplaint').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftComplaint').html('');
    });

    //投诉 ：项目前台
    $('.typeList_employeesReception').bind('click', function () {
        $('.group_listReception').css('display', 'none');
        $('.addPeopleReception').css('display', 'block');
        $('.departmentReception').css('margin-top', '-2.95%');
        $('.zTreeDemoBackgroundReception').css('display', 'none');
        $('.moveBtnReception').css('margin-top', '-1.54%');
        $('.typeList_employeesReception').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_departmentReception').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_groupReception').css({'background': '#fff', 'color': '#0D165E'});
        $('#leftReception').html('');
    });
    ...
    //报修 ： 数据查看
    $('.typeList_groupRepair1').bind('click', function () {
        var groupHtml = arr2Html(groupData1);
        $('.group_listRepair1').html(groupHtml);
        $('.group_listRepair1').css('display', 'block');
        $('.zTreeDemoBackgroundRepair1').css('display', 'none');
        $('#treeDemoRepair1').css('display', 'none');
        $('.departmentRepair1').css('margin-top', '-2.95%');
        $('.addPeopleRepair1').css('display', 'none');
        $('.moveBtnRepair1').css('margin-top', '3.1%');
        $('.content_wrapRepair1 .resultPeopleRepair1').css('display', 'none');
        $('.typeList_groupRepair1').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesRepair1').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_departmentRepair1').css({'background': '#fff', 'color': '#0D165E'});
        arrDataRepair1select(groupData1, '#leftDispatch');
    });
    //报修 ： 数据查看
    $('.serach_peopleRepair1').bind('click', function () {
        var serachPeople = $('.serach_people_keyRepair1').val();
        $.ajax({
            url: '/user/searchStaff',
            data: {
                staffName: serachPeople
            ...
            success: function (result) {
                if (result.code != 0) {
                    ...
                    arrDataRepair1select(data, '#leftRepair1');
                }
            }
        });
    });
    ...
    //投诉 ： 数据查看
    $('.typeList_groupComplaint').bind('click', function () {
        var groupHtml = arr2Html(groupData1);
        $('.group_listComplaint').html(groupHtml);
        $('.group_listComplaint').css('display', 'block');
        $('.zTreeDemoBackgroundComplaint').css('display', 'none');
        $('#treeDemoComplaint').css('display', 'none');
        $('.departmentComplaint').css('margin-top', '-2.95%');
        $('.addPeopleComplaint').css('display', 'none');
        $('.moveBtnComplaint').css('margin-top', '3.1%');
        $('.content_wrapComplaint .resultPeopleComplaint').css('display', 'none');
        $('.typeList_groupComplaint').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesComplaint').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_departmentComplaint').css({'background': '#fff', 'color': '#0D165E'});
        arrDataComplaintselect(groupData1, '#leftDispatch');
    });
    //投诉 ： 数据查看
    $('.serach_peopleComplaint').bind('click', function () {
        var serachPeople = $('.serach_people_keyComplaint').val();
        $.ajax({
            url: '/user/searchStaff',
            data: {
                staffName: serachPeople
            ...
            success: function (result) {
                if (result.code != 0) {
                    ...
                    arrDataComplaintselect(data, '#leftComplaint');
                }
            }
        });
    });
    ...
    //投诉 ： 项目前台
    $('.typeList_groupReception').bind('click', function () {
        var groupHtml = arr2Html(groupData1);
        $('.group_listReception').html(groupHtml);
        $('.group_listReception').css('display', 'block');
        $('.zTreeDemoBackgroundReception').css('display', 'none');
        $('#treeDemoReception').css('display', 'none');
        $('.departmentReception').css('margin-top', '-2.95%');
        $('.addPeopleReception').css('display', 'none');
        $('.moveBtnReception').css('margin-top', '3.1%');
        $('.content_wrapReception .resultPeopleReception').css('display', 'none');
        $('.typeList_groupReception').css({'background': '#0D165E', 'color': '#fff'});
        $('.typeList_employeesReception').css({'background': '#fff', 'color': '#0D165E'});
        $('.typeList_departmentReception').css({'background': '#fff', 'color': '#0D165E'});
        arrDataReceptionselect(groupData1, '#leftDispatch');
    });
    //投诉 ：  项目前台
    $('.serach_peopleReception').bind('click', function () {
        var serachPeople = $('.serach_people_keyReception').val();
        $.ajax({
            url: '/user/searchStaff',
            data: {
                staffName: serachPeople
            ...
            success: function (result) {
                if (result.code != 0) {
                    ...
                    arrDataReceptionselect(data, '#leftReception');
                }
            }
        });
    });
    ...
    var waitLists9 = {};
    var waitListsHQ = {};
    var waitListsRepair1 = {};
    var waitListsComplaint = {};
    var waitListsReception = {};
    var setting = {
        async: {
            enable: true,
    ...
    var settingRepair1 = {
        async: {
            ...
            autoParam: ["id", "name=n", "level=lv"],
            otherParam: {"otherParam": "zTreeAsyncTest"},
            dataFilter: filterRepair1,
        },
        callback: {
            onClick: onClickRepair1
        }
    };
    //投诉数据查看
    var settingComplaint = {
        async: {
            enable: true,
            url: "/agency/initAgency",
            autoParam: ["id", "name=n", "level=lv"],
            otherParam: {"otherParam": "zTreeAsyncTest"},
            dataFilter: filterComplaint,
        },
        callback: {
    ...
    //投诉项目前台
    var settingReception = {
        async: {
            enable: true,
            url: "/agency/initAgency",
            autoParam: ["id", "name=n", "level=lv"],
            otherParam: {"otherParam": "zTreeAsyncTest"},
            dataFilter: filterReception,
        },
        callback: {
...
//      if (treeNode.isParent) {
    ...
    //报修：数据查看
    function onClickRepair1(event, treeId, treeNode, clickFlag) {
        var childrenArr;
        var leftId = '#leftRepair1'
        $.getJSON('/agency/nextAgency?id=' + treeNode.id + '&type=' + treeNode.agencyType, function (res) {
            childrenArr = res.data;
            arrDataRepair1select(childrenArr, leftId);
        })
    }
    //投诉：数据查看
    function onClickComplaint(event, treeId, treeNode, clickFlag) {
        var childrenArr;
        var leftId = '#leftComplaint'
        $.getJSON('/agency/nextAgency?id=' + treeNode.id + '&type=' + treeNode.agencyType, function (res) {
            childrenArr = res.data;
            arrDataComplaintselect(childrenArr, leftId);
        })
    }

    //投诉：项目前台
    function onClickReception(event, treeId, treeNode, clickFlag) {
        var childrenArr;
        var leftId = '#leftReception'
        $.getJSON('/agency/nextAgency?id=' + treeNode.id + '&type=' + treeNode.agencyType, function (res) {
            childrenArr = res.data;
            arrDataReceptionselect(childrenArr, leftId);
        })
    }
    ...
    //报修 数据查看
    function filterRepair1(treeId, parentNode, childNodes) {
        if (!childNodes) {
            return null;
        }
        var arr = [];
        ...
        if (parentNode) {
            waitListsRepair1['id' + parentNode.id] = arr;
        } else {
            waitListsRepair1['idRoot'] = arr;
        }
        return childNodes;
    }

    //投诉 数据查看
    function filterComplaint(treeId, parentNode, childNodes) {
        if (!childNodes) {
            return null;
        }
        var arr = [];
        ...
        if (parentNode) {
            waitListsComplaint['id' + parentNode.id] = arr;
        } else {
            waitListsComplaint['idRoot'] = arr;
        }
        return childNodes;
    }

    //投诉项目前台
    function filterReception(treeId, parentNode, childNodes) {
        if (!childNodes) {
            return null;
        }
        var arr = [];
        ...
        if (parentNode) {
            waitListsReception['id' + parentNode.id] = arr;
        } else {
            waitListsReception['idRoot'] = arr;
        }
        return childNodes;
    }
...
//        temp3+=arr[i].id+",";
    ...
    //报修 数据查看
    function arrDataRepair1select(arr, id) {
        //arr相当于代表的是左侧已经选中的数据 id 代表的是右侧的数据
        if (id == '#rightRepair1' && arr != selecteRepair1) {
            arr = selecteRepair1.concat(arr)
            selecteRepair1 = arr;
        }
        ;
        var htmlPersonNum = 0;
        var htmlGroupNum = 0;
        var htmlDepartmentNum = 0;
        var htmlPerson = ')" id="htmlPersonRepair1" ">' + '</optgroup>';
        var htmlGroup = ')"  id="htmlGroupRepair1" ">' + '</optgroup>';
        var htmlDepartment = ')"  id="htmlDepartmentRepair1" ">' + '</optgroup>';
        for (var i = 0; i < arr.length; i++) {
            // 比较两个id看是否重复
            var isContains = contains(selecteRepair1.map(function (res) {
                return res.id
            }), arr[i].id);
            if (isContains && id == '#leftRepair1') {
                continue;
            }
            ;
            if (arr[i].type == '1') {
    ...
    //投诉 数据查看
    function arrDataComplaintselect(arr, id) {
        //arr相当于代表的是左侧已经选中的数据 id 代表的是右侧的数据
        if (id == '#rightComplaint' && arr != selecteComplaint) {
            arr = selecteComplaint.concat(arr)
            selecteComplaint = arr;
        }
        ;
        var htmlPersonNum = 0;
        var htmlGroupNum = 0;
        var htmlDepartmentNum = 0;
        var htmlPerson = ')" id="htmlPersonComplaint" ">' + '</optgroup>';
        var htmlGroup = ')"  id="htmlGroupComplaint" ">' + '</optgroup>';
        var htmlDepartment = ')"  id="htmlDepartmentComplaint" ">' + '</optgroup>';
        for (var i = 0; i < arr.length; i++) {
            // 比较两个id看是否重复
            var isContains = contains(selecteComplaint.map(function (res) {
                return res.id
            }), arr[i].id);
            if (isContains && id == '#leftComplaint') {
                continue;
            }
            ;
            if (arr[i].type == '1') {
    ...
    //投诉 项目前台
    function arrDataReceptionselect(arr, id) {
        //arr相当于代表的是左侧已经选中的数据 id 代表的是右侧的数据
        if (id == '#rightReception' && arr != selecteReception) {
            arr = selecteReception.concat(arr)
            selecteReception = arr;
        }
        ;
        var htmlPersonNum = 0;
        var htmlGroupNum = 0;
        var htmlDepartmentNum = 0;
        var htmlPerson = ')" id="htmlPersonReception" ">' + '</optgroup>';
        var htmlGroup = ')"  id="htmlGroupReception" ">' + '</optgroup>';
        var htmlDepartment = ')"  id="htmlDepartmentReception" ">' + '</optgroup>';
        for (var i = 0; i < arr.length; i++) {
            // 比较两个id看是否重复
            var isContains = contains(selecteReception.map(function (res) {
                return res.id
            }), arr[i].id);
            if (isContains && id == '#leftReception') {
                continue;
            }
            ;
            if (arr[i].type == '1') {
    ...
    function select() {
        ...
        //报修 数据查看
        $('#btnRRepair1').bind('click', function () {
            waitRepair1Selected();
        });
        $('#btnDRepair1').bind('click', function () {
            selectedRepair1Wait();
        });

        //投诉 数据查看
        $('#btnRComplaint').bind('click', function () {
            waitComplaintSelected();
        });
        $('#btnDComplaint').bind('click', function () {
            selectedComplaintWait();
        });

        //投诉 项目前台
        $('#btnRReception').bind('click', function () {
            waitReceptionSelected();
        });
        $('#btnDReception').bind('click', function () {
            selectedReceptionWait();
        });
    ...
    //报修 数据查看 右移方法
    function waitRepair1Selected() {
        //将左侧选中的数据放进一个数组中
        var optionArr = $('#leftRepair1 option:selected');
        // console.log(optionArr);
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
        ...
        //移除之前选中的那个数组
        optionArr.remove();
        arrDataRepair1select(arr, '#rightRepair1');
    }
    //报修 数据查看 左移方法
    function selectedRepair1Wait() {
        var optionArr = $('#rightRepair1 option:selected');
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
            if (optionArr[i].className == 'htmlPerson') className = '3';
        ...
        optionArr.remove();
        // selectedData
        selecteRepair1 = arrSubtraction(selecteRepair1, arr)
        $('#rightRepair1 #htmlPersonRepair1')[0].label = "员工(" + $('#rightRepair1').find('.htmlPerson').length + ")";
        $('#rightRepair1 #htmlDepartmentRepair1')[0].label = "部门(" + $('#rightRepair1').find('.htmlDepartment').length + ")";
        $('#rightRepair1 #htmlGroupRepair1')[0].label = "群组(" + $('#rightRepair1').find('.htmlGroup').length + ")";
        var optionArrLeft = $('#leftRepair1 option');
        var arrLeft = [];
        for (var i = 0; i < optionArrLeft.length; i++) {
            var className = '1';
            if (optionArrLeft[i].className == 'htmlPerson') className = '3';
        ...
        ;
        arr = arrLeft.concat(arr)
        arrDataRepair1select(arr, '#leftRepair1')
    }

    //投诉 数据查看 右移方法
    function waitComplaintSelected() {
        //将左侧选中的数据放进一个数组中
        var optionArr = $('#leftComplaint option:selected');
        // console.log(optionArr);
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
        ...
        //移除之前选中的那个数组
        optionArr.remove();
        arrDataComplaintselect(arr, '#rightComplaint');
    }
    //投诉 数据查看 左移方法
    function selectedComplaintWait() {
        var optionArr = $('#rightComplaint option:selected');
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
            if (optionArr[i].className == 'htmlPerson') className = '3';
        ...
        optionArr.remove();
        // selectedData
        selecteComplaint = arrSubtraction(selecteComplaint, arr)
        $('#rightComplaint #htmlPersonComplaint')[0].label = "员工(" + $('#rightComplaint').find('.htmlPerson').length + ")";
        $('#rightComplaint #htmlDepartmentComplaint')[0].label = "部门(" + $('#rightComplaint').find('.htmlDepartment').length + ")";
        $('#rightComplaint #htmlGroupComplaint')[0].label = "群组(" + $('#rightComplaint').find('.htmlGroup').length + ")";
        var optionArrLeft = $('#leftComplaint option');
        var arrLeft = [];
        for (var i = 0; i < optionArrLeft.length; i++) {
            var className = '1';
            if (optionArrLeft[i].className == 'htmlPerson') className = '3';
        ...
        ;
        arr = arrLeft.concat(arr)
        arrDataComplaintselect(arr, '#leftComplaint')
    }

    //投诉 项目前台  右移方法
    function waitReceptionSelected() {
        //将左侧选中的数据放进一个数组中
        var optionArr = $('#leftReception option:selected');
        // console.log(optionArr);
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
        ...
        //移除之前选中的那个数组
        optionArr.remove();
        arrDataReceptionselect(arr, '#rightReception');
    }
    //投诉 项目前台 左移方法
    function selectedReceptionWait() {
        var optionArr = $('#rightReception option:selected');
        var arr = [];
        for (var i = 0; i < optionArr.length; i++) {
            var className = '1';
            if (optionArr[i].className == 'htmlPerson') className = '3';
        ...
        optionArr.remove();
        // selectedData
        selecteReception = arrSubtraction(selecteReception, arr)
        $('#rightReception #htmlPersonReception')[0].label = "员工(" + $('#rightReception').find('.htmlPerson').length + ")";
        $('#rightReception #htmlDepartmentReception')[0].label = "部门(" + $('#rightReception').find('.htmlDepartment').length + ")";
        $('#rightReception #htmlGroupReception')[0].label = "群组(" + $('#rightReception').find('.htmlGroup').length + ")";
        var optionArrLeft = $('#leftReception option');
        var arrLeft = [];
        for (var i = 0; i < optionArrLeft.length; i++) {
            var className = '1';
            if (optionArrLeft[i].className == 'htmlPerson') className = '3';
        ...
        ;
        arr = arrLeft.concat(arr)
        arrDataReceptionselect(arr, '#leftReception')
    }
    select();
    $(document).ready(function () {
        ...
        $.fn.zTree.init($("#treeDemoRepair1"), settingRepair1);
        $.fn.zTree.init($("#treeDemoComplaint"), settingComplaint);
        $.fn.zTree.init($("#treeDemoReception"), settingReception);
    });
    ...
    //报修 数据查看 提交选择
    $('.confirmRepair1').bind('click', function () {
        var liShow = $('#rightRepair1').html();
        $('.selectResultRepair1').html(liShow);
        $('.selectResultRepair1').find('option').addClass('floatSelectResult');
        $('#htmlGroupRepair1').css('display', 'none');
        $('#htmlPersonRepair1').css('display', 'none');
        $('#htmlDepartmentRepair1').css('display', 'none');
        var tstaff = [], tagency = [], torganize = [];
        var i = j = k = 0;
        $("#rightRepair1 option").each(function () {
            if ($(this).attr("class") == 'htmlDepartment') {
                tagency[i] = $(this).attr("data-id");
                i++;
            } else if ($(this).attr("class") == 'htmlGroup') {
        ...
        $('#Repair1ObjectiveStaffs').val(tstaff.join());
        $('#Repair1ObjectiveAgencys').val(tagency.join());
        $('#Repair1ObjectiveOrganizes').val(torganize.join());
    });

    //投诉 数据查看 提交选择
    $('.confirmComplaint').bind('click', function () {
        var liShow = $('#rightComplaint').html();
        $('.selectResultComplaint').html(liShow);
        $('.selectResultComplaint').find('option').addClass('floatSelectResult');
        $('#htmlGroupComplaint').css('display', 'none');
        $('#htmlPersonComplaint').css('display', 'none');
        $('#htmlDepartmentComplaint').css('display', 'none');
        var tstaff = [], tagency = [], torganize = [];
        var i = j = k = 0;
        $("#rightComplaint option").each(function () {
            if ($(this).attr("class") == 'htmlDepartment') {
                tagency[i] = $(this).attr("data-id");
                i++;
            } else if ($(this).attr("class") == 'htmlGroup') {
        ...
        $('#ComplaintObjectiveStaffs').val(tstaff.join());
        $('#ComplaintObjectiveAgencys').val(tagency.join());
        $('#ComplaintObjectiveOrganizes').val(torganize.join());
    });

    //投诉 项目前台 提交选择
    $('.confirmReception').bind('click', function () {
        var liShow = $('#rightReception').html();
        $('.selectResultReception').html(liShow);
        $('.selectResultReception').find('option').addClass('floatSelectResult');
        $('#htmlGroupReception').css('display', 'none');
        $('#htmlPersonReception').css('display', 'none');
        $('#htmlDepartmentReception').css('display', 'none');
        var tstaff = [], tagency = [], torganize = [];
        var i = j = k = 0;
        $("#rightReception option").each(function () {
            if ($(this).attr("class") == 'htmlDepartment') {
                tagency[i] = $(this).attr("data-id");
                i++;
            } else if ($(this).attr("class") == 'htmlGroup') {
        ...
        $('#ReceptionObjectiveStaffs').val(tstaff.join());
        $('#ReceptionObjectiveAgencys').val(tagency.join());
        $('#ReceptionObjectiveOrganizes').val(torganize.join());
    });
