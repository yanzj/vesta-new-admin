...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../user/ownerManage.html">
          <%--项目--%>
  ...
  <div class="table-responsive bs-example widget-shadow">
    ...
    <table width="100%" class="tableStyle">
      ...
      <tbody>
      <c:forEach items="${userOwnerDTOs}" var="owner" varStatus="vs">
        <tr>
          <td><b>${vs.count}</b></td>
          <td>${owner.realNameDto}</td>
          <td>${owner.userNameDto}</td>
         ...
         <%--&lt;%&ndash;删除   <a href="../user/deleteStaffManage?staffId=${staff.staffId}" class="a3"><span class="span1"><spring:message code="common_delete" /></span></a>&ndash;%&gt;--%>
          <%--</td>--%>
        </tr>
      </c:forEach>
      </tbody>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/user/ownerManage.html?pageIndex={0}&projectId=${project.projectId}&buildingId=${building.buildingId}&unitId=${unit.unitId}&roomId=${room.roomId}&userNameDto=${userOwnerDTO.userNameDto}&realNameDto=${userOwnerDTO.realNameDto}&mobileDto=${userOwnerDTO.mobileDto}&beginTime=${userOwnerDTO.beginTime}&endTime=${userOwnerDTO.endTime}"/>
  </div>
