...
<div class="main-content">
  <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="005200040000" username="${propertystaff.staffName}" />
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body form_b">
        <form:form class="form-horizontal" action="../user/housemateUserManagement.html" modelAttribute="commonUserSearch" method="get">
          <input type="hidden" id="menuId" name="menuId" value="005200040000">
          <%--
          ...
          <div class="form-group  col-xs-4">
            <label for="beginTime" class="col-sm-4 control-label"><spring:message code="ownerManage.authorization"/></label>
  ...
  <div class="table-responsive bs-example widget-shadow">
    ...
    <table width="100%" class="tableStyle table-striped">
      ...
      <tr>
        ...
        <th>授权人用户名</th>
        <th>授权人微信昵称</th>
        <th><spring:message code="ownerManage.authorization" /></th>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/user/housemateUserManagement.html?menuId=005200030000&pageIndex={0}&scopeId=${commonUserSearch.scopeId}&projectId=${commonUserSearch.projectId}&userName=${commonUserSearch.userName}&mobile=${commonUserSearch.mobile}&idCard=${commonUserSearch.idCard}&beginTime=${commonUserSearch.beginTime}&endTime=${commonUserSearch.endTime}"/>
  </div>
</div>
</div>
</div>
...
<script type="text/javascript">
  ...
  function isExcel(){
    var size = $("#size").val();
    if(size>0){
      var href = "../user/exportExcel?type=3&pageIndex={0}&scopeId=${commonUserSearch.scopeId}&projectId=${commonUserSearch.projectId}&userName=${commonUserSearch.userName}&mobile=${commonUserSearch.mobile}&idCard=${commonUserSearch.idCard}&beginTime=${commonUserSearch.beginTime}&endTime=${commonUserSearch.endTime}";
