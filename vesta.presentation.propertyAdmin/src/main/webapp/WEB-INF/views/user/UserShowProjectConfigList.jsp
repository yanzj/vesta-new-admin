...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      ...
      <div class="form-body form_b">
        <form id="form" class="form-horizontal" action="../defaultConfig/userShowProjectConfigList.html">
  ...
  <div class="table-responsive bs-example widget-shadow">
      ...
      <table width="100%" class="tableStyle">
        ...
        <c:forEach items="${projectConfigList}" var="projectConfig" varStatus="row">
          <tr>
            ...
            <td>
                ${fn:replace(fn:replace(fn:replace(fn:replace(fn:replace(projectConfig.userTypes, "6", "虚拟用户"), "4", "房屋关系人"), "3", "业主"), "2", "普通用户"), "1", "游客")}
            </td>
            <td class="last">
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/defaultConfig/userShowProjectConfigList.html?menuId=000200050000&pageIndex={0}&cityId=${userTypeProjectConfigDTO.cityId}&projectNum=${userTypeProjectConfigDTO.projectNum}"/>
  </div>
  ...
  function toEdit(projectNum){
    $.ajax({
      ...
      success: function (data) {
        if (data.error == 1) {
          window.location.href = "../defaultConfig/toEditUserShowProjectConfig.html?projectNum="+projectNum;
