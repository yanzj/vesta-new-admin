    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body form_b">
                <form id="form" class="form-horizontal" action="../defaultConfig/appShowFunctionConfigList.html">
    ...
    <div class="table-responsive bs-example widget-shadow">
        <form id="batchForm" class="form-horizontal" action="../staffUser/toBatchSetRole">
            <table width="100%" class="tableStyle">
                ...
                <tbody>
                <c:forEach items="${functionConfigList}" var="functionConfig" varStatus="row">
                    <tr>
                        <td><b>${row.index + 1}</b></td>
                        <td>${functionConfig.projectName}</td>
                        <td>${functionConfig.functionModuleStr}</td>
                        <td class="last">
                            <a href="javascript:void(0);" onclick="toEdit('${functionConfig.projectNum}')" id="edit"
                               class="a3">编辑</a>
                        </td>
                    </tr>
                </c:forEach>
        ...
        <m:pager pageIndex="${webPage.pageIndex}"
                 ...
                 submitUrl="${pageContext.request.contextPath }/defaultConfig/appShowFunctionConfigList.html?menuId=000200060000&pageIndex={0}&cityId=${userTypeProjectConfigDTO.cityId}&projectNum=${userTypeProjectConfigDTO.projectNum}"/>
    </div>
    ...
    function toEdit(projectNum){
        $.ajax({
            ...
            success: function (data) {
                if (data.error == 1) {
                    window.location.href = "../defaultConfig/toEditAppShowFunctionConfig.html?projectNum="+projectNum;
