...
<div class="main-content">
    ...
    <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001200010000" username="${authPropertystaff.staffName}" />
                ...
                <form class="form-horizontal" name="search" action="../problem/problemManagement.html" method="get">
                    <div style=" margin-left: -5%;">
                        ...
                        <div class="form-group  col-lg-4">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" placeholder="" id="caseState" name="caseState">
                                    ...
                                    <option value="有效问题" <c:if test="${problem.caseState eq '有效问题'}">selected</c:if>>有效问题</option>
                        ...
                        <div class="form-group  col-lg-4">
                            ...
                            <div style="padding-right: 0;" class="input-group date form_date col-sm-8" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2">
                        ...
                        <%-- 供应商 --%>
                        <div class="form-group  col-lg-4">
                            <label for="supplier" class="col-sm-4 control-label"><spring:message code="problem.supplier"/>：</label>
                            <div class="col-sm-8">
                        ...
                        <%-- 创建人 --%>
                        <div class="form-group  col-lg-4">
                            <label for="createByName" class="col-sm-4 control-label"><spring:message code="problem.createByName"/>：</label>
                            <div class="col-sm-8">
                        ...
                        <%-- 派单人 --%>
                        <div class="form-group  col-lg-4">
                            <label for="senUserName" class="col-sm-4 control-label"><spring:message code="problem.senUserName"/>：</label>
                            <div class="col-sm-8">
                        ...
                        <%-- 处理人 --%>
                        <div class="form-group  col-lg-4">
                            <label for="dealPeopleName" class="col-sm-4 control-label"><spring:message code="problem.dealPeopleName"/>：</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" placeholder="" id="dealPeopleName" name="dealPeopleName">
                            </div>
                        </div>
                        <%-- 问题描述 --%>
                        <div class="form-group  col-lg-4">
                            <label for="bewrite" class="col-sm-4 control-label"><spring:message code="problem.bewrite"/>：</label>
                            <div class="col-sm-8">
                        ...
                        <%-- 填报人 --%>
                        <div class="form-group  col-lg-4">
                            <label for="upcloseName" class="col-sm-4 control-label"><spring:message code="problem.upcloseName"/>：</label>
                            <div class="col-sm-8">
                    ...
                    <c:if test="${function.qch40010035 eq 'Y'}">
                        <button type="submit" class="btn btn-primary" for="propertySearch" ><spring:message code="problem.search"/></button>
                    </c:if>
                    <c:if test="${function.qch40010036 eq 'Y'}">
                        <a  href="../problem/preAddProblemManagement?planType=13" class="btn btn-primary" for="rolesetAdd" ><spring:message code="problem.add"/></a>
                    </c:if>
                    <c:if test="${function.qch40010037 eq 'Y'}">
    ...
    <div class="table-responsive bs-example widget-shadow" >
        <form action="../problem/batchCommit">
            <c:if test="${function.qch40010038 eq 'Y'}">
            ...
            <table width="100%" class="tableStyle" style="table-layout: fixed;">
                ...
                <c:forEach items="${problems}" var="problem" varStatus="row">
                    <tr>
                        <td height="40px" style="text-align: center"><c:if test="${problem.caseState eq '草稿'}"><input name="ids" type="checkbox" value="${problem.caseId}"/><b></c:if>${(webPage.pageIndex-1)*20+row.index+1}</b></td>
                        <td height="40px" style="padding-left:10px;text-align: center;">${problem.isOverdue}</td>
                        <td height="40px">
                        ...
                        <td height="40px"><fmt:formatDate  type="date" value="${problem.createDate}" dateStyle="default" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                            <%--${problem.createDate}--%>
                        <td height="40px">
                        ...
                        <td height="40px">
                            <c:if test="${function.qch40010041 eq 'Y'}">
