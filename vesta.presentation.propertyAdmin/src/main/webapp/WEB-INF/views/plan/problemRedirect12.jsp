      ...
      <div class="form-body">
        ...
        <div class="form-body" style="min-height:880px">
          <form class="form-horizontal" id="frm" action="../problem/ToRePieOrder" method="post"
            ...
            <%--<label class="col-sm-4 control-label" for="buildingNum"><spring:message--%>
            ...
            <%--所属单元--%>
            <%--<div class="form-group col-lg-4">--%>
            <%--<label class="col-sm-4  control-label" for="unitNum"><spring:message--%>
            ...
            <%--所属楼层--%>
            <%--<div class="form-group col-lg-4">--%>
            <%--<label class="col-sm-4 control-label" for="floorNum"><spring:message--%>
            ...
            <%--所属房间--%>
            <%--<div class="form-group col-lg-4">--%>
            <%--<label class="col-sm-4 control-label" for="roomNum"><spring:message--%>
