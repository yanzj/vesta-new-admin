...
<head>problemDetail
    ...
    <script>
        $(function () {
            console.log("sqq")
            $("#001000010000").addClass("active");
            $("#001000010000").parent().parent().addClass("in");
            $("#001000010000").parent().parent().parent().parent().addClass("active");
        })
        new WOW().init();
    </script>
    <!--//end-animate-->
...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="001000010000" username="${authPropertystaff.staffName}"/>
    ...
    <div class="newDetail__">
        <div class="nav">
            <div class="rightButton">
                ...
                <td>
                    <c:if test="${function.qch40010008 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已完成'&&problem.caseState ne '草稿'&&problem.caseState ne '已废弃'}">
              ...
              <%--  <td>
                ...
                <td>
                    <c:if test="${function.qch40010009 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已完成' && problem.caseState ne '已废弃'}">
                ...
                <td>
                    <c:if test="${function.qch40010010 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已废弃'}">
                ...
                <td>
                    <c:if test="${function.qch40010011 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '草稿' && problem.caseState ne '已完成'&&problem.caseState ne '已废弃'}">
        ...
        <div class="notice_head" style="height: 130px;width: 90%;border-bottom: 1px dashed #ccc;">
            <h2 style="font-size: 18px;text-align: left;height: 40px;font-weight: bold;">内部预验整改单</h2>
            ...
            <span class="record_num" style="min-width: 40%;"><spring:message code="problem.createby"/>：${problem.createBy}(${problem.createCode})</span>
          ...
          <%--  <span class="key1 notice_time " style="min-width: 225px;"><spring:message code="problem.senUserName"/>：${problem.senUserName}</span>--%>
            <%--</div>--%>
            <%--problem.senDate = 派单人时间--%>
            <%--<div class="duration">--%>
              <%--  <span class="key1 ques_sta" style="min-width: 225px;"><spring:message code="problem.senDate"/>：<fmt:formatDate type="date"
            ...
            <%--<div class="repair_per">--%>
            <span class="key1 " style="min-width: 225px;"><spring:message code="problem.upcloseName"/>：${problem.upcloseName}</span>

            <%--</div>--%>
            <%--problem.upcloseDate = 填报时间--%>
            <%--<div class="duration">--%>
                <span class="key1 ques_sta" style="min-width: 225px;"><spring:message code="problem.upcloseDate"/>： <fmt:formatDate type="date"
