...
<head>
    ...
    <style>
        ...
        /*new style 2016-07-26*/
      /*  .form-body .form-horizontal .form-group{
            margin-left: 0;
        }
*/
        div.col-lg-8 {
...
<div class="main-content">
    <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001000010000" username="${authPropertystaff.staffName}" />
    <div class="forms">
...
//        新添加的数据校验
    ...
    $("#projectNum").change(function(){
        ...
        $.ajax({
            ...
            type:"get",
            async:"false",
            data:{ "projectNum":projectNum,"planType":"11"},
            dataType:"json",
            error:function(){
                alert("网络异常，可能服务器忙，请刷新重试");
            },
