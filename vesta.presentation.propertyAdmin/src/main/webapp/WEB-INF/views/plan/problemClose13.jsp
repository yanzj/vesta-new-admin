...
<div class="main-content">
  <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001200010000" username="${propertystaff.staffName}" />
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      ...
      <div class="form-body">
        ...
        <div class="form-body" style="min-height:880px">
          <form class="form-horizontal" id="frm" action="../problem/closeQeustionTime" method="post"
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-4">
                <select class="form-control" disabled="disabled" placeholder="" id="buildingNum" name="buildingNum">
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-4">
                <select class="form-control" disabled="disabled" placeholder="" id="unitNum" name="unitNum">
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-4">
                <select class="form-control" disabled="disabled" placeholder="" id="floorNum" name="floorNum">
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-4">
                <select class="form-control" disabled="disabled" placeholder="" id="roomNum" name="roomNum">
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-10" id="problemtypediv">
            ...
            <div class="form-group col-lg-12">
              ...
              <div class="col-sm-4">
                <textarea class="form-control" id="dealResult" name="dealResult">${problem.dealResult}</textarea>
              </div>
            </div>

              <%--整改图片--%>
            <div class="form-group col-lg-12">
              <label class="col-sm-2 control-label" for="reviewImgFile"><spring:message code="problem.image"/></label>

              <div class="col-sm-4">
                <div id="reviewfileId">
                  <input type="file" id="reviewf1" name="reviewImgFile" class="form-control"  onchange="check(this)">
                </div>
            ...
            <div class="text-right form-group  col-lg-6" style="padding:0;">
              <button type="button" class="btn btn-primary" onclick="checkSubmit('草稿')"><spring:message code="problem.close"/></button>
              ...
              <%--<c:if test="${problem.rectifyState eq '处理中'}">--%>
                <%--<button type="button" class="btn btn-primary" onclick="checkSubmit('处理中')"><spring:message code="problem.save"/></button>--%>
