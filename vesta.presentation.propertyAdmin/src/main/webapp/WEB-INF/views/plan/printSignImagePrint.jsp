...
<script type="application/javascript">
    $(function(){
//        var answer = document.getElementsByName("planType");

//        if(answer=='13'){
            $("#001200020000").removeClass("active");
            $("#001200020000").parent().parent().addClass("in");
            $("#001200030000").addClass("active");
            $("#001200030000").parent().parent().addClass("in");
//        }
    })
</script>
<body class="cbp-spmenu-push">
<div class="main-content">
    <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001200030000" username="${authPropertystaff.staffName}" />
    <div class="forms">
            ...
            <div class="form-body">
                ...
                <form class="form-horizontal" id="search" name="search" action="../problem/problemPrintNew.html" method="get">
                    <div style="margin-left: -5%;">
                        ...
                        <%--</div>--%>
                            <input type="hidden" id="signaType" name="signaType" value="${signaType}">
                ...
                <tr>
                    ...
                    <%--<td>--%>
                        ...
                        <%--<c:if test="${problem.planType eq '12'}">--%>
                            ...
                            <%--&lt;%&ndash;<c:if test="${problem.state eq 'inspectionNot'}">验房未通过</c:if>&ndash;%&gt;--%>
                        <%--</c:if>--%>
                    ...
                    <td>
                        <c:if test="${function.qch40010054 eq 'Y'}">
                            <a href="javascript:void(0);" onclick="isProblemRoomPrint('${problem.caseState}','${problem.projectNum}','${problem.roomNum}','${problem.planType}','${problem.planNum}','${problem.successOrFailure}','${signaType}')" >
...
<script>
    ...
    function isProblemRoomPrint(caseState,projectNum,roomNum,planType,planNum,successOrFailure,signaType){
        var room=escape(roomNum)
        var href = encodeURI("../problem/problemRoomPrint.html?caseState="+caseState+"&projectId="+projectNum+"&roomId="+room+"&proType="+planType+"&planNum="+planNum+"&successOrFailure="+successOrFailure+"&signaType="+signaType+"");
        window.location.href = href;
    }
