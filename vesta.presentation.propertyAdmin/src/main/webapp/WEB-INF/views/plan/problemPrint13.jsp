...
//      $("#003200010000").parent().parent().parent().parent().addClass("active");
        ...
        //打印  可以使用escape()函数或者encodeURIComponent()
        function toObtain(){
            var type=13;
            //首先选择房间号
...
<div class="main-content">
    ...
    <vl:leftmenu  sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>" crunMenu="001200020000" username="${propertystaff.staffName}" />
        ...
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                <form class="form-horizontal" id="search" name="search" action="../problem/problemPrint.html" method="get">
                    ...
                    <%--<a  href="../problem/preAddProblemPrint?planType=13" class="btn btn-primary" for="rolesetAdd" ><spring:message code="problem.add"/></a>--%>
                    <a href="javascript:void(0);" onclick="toObtain();" class="btn btn-primary" style="color:#fff">打印交房单</a>
