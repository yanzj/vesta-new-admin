...
//      $("#003200010000").parent().parent().parent().parent().addClass("active");
        ...
        function toSign(){
            ...
            window.open("../problem/signaturePrinting?caseIds="+ s+"&rId="+encodeURIComponent(rId)+"&projectId="+projectId+"&type="+type+"&planNum="+planNum,"_blank");
...
<div class="main-content">
    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            ...
            <div class="form-body">
                ...
                <c:if test="${function.qch40010055 eq 'Y'}">
                    <a href="javascript:void(0);" onclick="toSign()" class="btn btn-primary" style="color:#fff">打印验房单</a>
                </c:if>
            </div>
            <%--搜索条件结束--%>
        </div>
    ...
    <div class="table-responsive bs-example widget-shadow">
        <table width="100%" class="tableStyle" style="table-layout: fixed;">
            ...
            <input type="hidden" id="planNum" name="planNum" value="${planNum}" />
            </tbody>
        </table>
