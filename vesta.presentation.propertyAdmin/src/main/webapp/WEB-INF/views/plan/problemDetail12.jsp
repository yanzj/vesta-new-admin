    ...
    <div class="newDetail__">
        <div class="nav">
            <div class="rightButton">
                ...
                <td>
                    <c:if test="${function.qch40010025 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已完成'&&problem.caseState ne '草稿'&&problem.caseState ne '已废弃' &&problemRole.closeProblem eq '1'}">
             ...
             <%--   <td>
                ...
                <td>
                    <c:if test="${function.qch40010026 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已完成' && problem.caseState ne '已废弃'&&problemRole.dealProblem eq '1'}">
                ...
                <td>
                    <c:if test="${function.qch40010027 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '已废弃'&&problemRole.deleProblem eq '1'}">
                ...
                <td>
                    <c:if test="${function.qch40010028 eq 'Y' && problem.caseState ne '强制关闭' && problem.caseState ne '草稿' && problem.caseState ne '已完成'&&problem.caseState ne '已废弃' &&problemRole.closeProblem eq '1'}">
        ...
        <div class="notice_head" style="height: 130px;width: 90%;border-bottom: 1px dashed #ccc;">
            <h2 style="font-size: 18px;text-align: left;height: 40px;font-weight: bold;">工地开放整改单</h2>
