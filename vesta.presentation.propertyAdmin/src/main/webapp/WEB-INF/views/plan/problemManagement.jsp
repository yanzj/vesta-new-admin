...
<div class="main-content">
    ...
    <div class="table-responsive bs-example widget-shadow">
        <form action="../problem/batchCommit">
            <c:if test="${function.qch40010004 eq 'Y'}">
            ...
            <table width="100%" class="tableStyle" style="table-layout: fixed;">
                ...
                <c:forEach items="${problems}" var="problem" varStatus="row">
                    <tr>
                        ...
                        <td height="40px">
                            <c:if test="${function.qch40010007 eq 'Y'}">
...
<script>
    ...
    function isExcel() {
        ...
        <%--if (size > 0) {--%>
        <%--var href = "../problem/exportExcel?pageIndex=${webPage.pageIndex}&projectId=${problem.projectId}&buildingId=${problem.buildingId}&roomId=${problem.roomId}&rectifyId=${problem.rectifyId}&caseState=${problem.caseState}&oneType=${problem.oneType}&twoType=${problem.twoType}&threeType=${problem.threeType}&proType=${problem.proType}&startDate=${problem.startDate}&endDate=${problem.endDate}&supplier=${problem.supplier}&createByName=${problem.createByName}&senUserName=${problem.enUserName}&dealPeopleName=${problem.dealPeopleName}&bewrite=${problem.bewrite}&upcloseName=${problem.upcloseName}&rectifyId=${problem.rectifyId}";--%>
        <%--&lt;%&ndash;var href = "../problem/exportExcel?pageIndex=${webPage.pageIndex}&projectId=${problem.projectId}&buildingId=${problem.buildingId}&roomId=${problem.roomId}&rectifyId=${problem.rectifyId}&caseState=${problem.caseState}&oneType=${problem.oneType}&twoType=${problem.twoType}&threeType=${problem.threeType}&proType=${problem.proType}&startDate=${problem.startDate}&endDate=${problem.endDate}";&ndash;%&gt;--%>
