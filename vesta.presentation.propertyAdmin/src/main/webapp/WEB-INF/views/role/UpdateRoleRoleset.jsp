...
<div class="main-content">
    ...
    <div class="container1 userStaffManage">
        <form class="form-horizontal" name="roleSetUpdate" id="roleSetUpdate" action="../role/UpdateRoleRoleset.html">
            ...
            <input type="hidden" name="setId" value="${roleRoleSet.setId}">
                                ...
                                <td>
                                    <c:forEach var="roleRole" items="${roleRoleDTOs}">
                                        <c:if test="${roleMould.roleDesc eq roleRole.roledesc}">
                                            <input type="checkbox" name="jsonStr" value="${roleRole.roleId}"
                                                   <c:if test="${roleRole.checkOut eq '1'}">checked="checked"</c:if>/>${roleRole.roleName}
                                        </c:if>
                                    </c:forEach>
                                </td>
                            </tr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <select id="right" multiple="multiple">
                                                <c:forEach items="${roleRoleSet.agencyList}" var="agency">
                                                    <option class="htmlDepartment"
                                                            value="${agency.agencyId}">${agency.agencyName}</option>
                                                </c:forEach>
                                                <c:forEach items="${roleRoleSet.staffList}" var="staff">
