...
<head>
  ...
  <!--//Metis Menu -->
  <script src="../static/property/js/propertyAnywherePic.js"></script>
</head>
...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../property/PropertyAnywherePic.html">
          ...
          <div class="form-group  col-lg-4">
            <label for="title" class="col-sm-3 control-label"><spring:message code="propertyReport.reprotTitle"/></label>

            <div class="col-sm-9">
              <input type="text" class="form-control" placeholder="" value="${anywhereReporPage.title}" id="title" name="title">
            </div>
          </div>
  ...
  <div class="table-responsive bs-example widget-shadow">
    <table width="100%" class="tableStyle">
      ...
      <tr>
        ...
        <td><spring:message code="propertyReport.reprotTitle" /></td>
        ...
        <td><spring:message code="propertyConsult.replyStatus" /></td>
      ...
      <c:forEach items="${anywhereRepor}" var="anywhere" varStatus="row">
        <tr>
          ...
          <td>${anywhere.replyStatus}</td>
          <td>
            <c:if test="${anywhere.state == '2'}">
              <c:if test="${anywhere.workType == 1}"><a href="javascript:void(0);" onclick="js_workMessage('${anywhere.anywherePicId}','${anywhere.workType}')">转为工单</a></c:if>
              <c:if test="${anywhere.workType == 2}"><a href="javascript:void(0);" onclick="js_workMessage('${anywhere.anywherePicId}','${anywhere.workType}')">已转工单</a></c:if>
            </c:if>
            <a href="../property/NewPropertyAnywherePic?anywherePicId=${anywhere.anywherePicId}"><spring:message code="propertyConsult.reply"/></a>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/property/PropertyAnywherePic.html?pageIndex={0}&houseId=${anywhereReporPage.houseId}&title=${anywhereReporPage.title}&makedateStart=${anywhereReporPage.makedateStart}&makedateEnd=${anywhereReporPage.makedateEnd}&userName=${anywhereReporPage.userName}"/>
  </div>
...
<script type="text/javascript">
  ...
  var title = "${anywhereReporPage.title}";
