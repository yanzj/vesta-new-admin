      ...
      <div class="form-body">
        <%--<form class="form-horizontal" action="../circle/clubTopicManage.html">--%>
          ...
          <div class="form-group  col-lg-6">
            ...
            <div class="col-sm-9">
               ${circleTopicDTO.circleTopicName}
            </div>
          </div>
          <%--发布人--%>
          <div class="form-group  col-lg-6">
          ...
          <a  href="../circle/clubTopicManage.html" class="btn btn-primary" for="" ><spring:message code="common_back"/></a>
    ...
    <table width="100%" class="tableStyle">
      <c:forEach items="${circleReplyDTOs}" var="reply">
        <tr>
          ...
          <td>
           <input type="test" class="form-control" placeholder="" value="${reply.content}" readonly>
          </td>
        </tr>
        <tr>
          <td>
              @${reply.replayUserName}
          </td>
          <td>
              ${reply.createOn}
            <a href="../circle/delClubReply?id=${reply.id}&topicId=${circleTopicDTO.circleTopicId}" class="a3"><span class="span1"><spring:message code="common_delete" /></span></a>
          </td>
        </tr>
      </c:forEach>
    </table>
