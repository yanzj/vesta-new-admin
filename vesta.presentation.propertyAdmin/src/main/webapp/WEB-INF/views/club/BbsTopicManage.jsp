...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../circle/bbsTopicManage.html">
          <%--俱乐部下拉框--%>
          <div class="form-group  col-lg-6">
            <label for="circleType" class="col-sm-3 control-label"><spring:message code="clubTopic.Module" /></label>
            <div class="col-sm-9">
              <select name="circleType" id="circleType" class="form-control">
                <option value="bbs" <c:if test="${circleTopicDTO.circleType eq 'bbs'}">selected="selected"</c:if>>----------<spring:message code="clubTopic.BBS" />----------</option>
                <option value="fleaMarket" <c:if test="${circleTopicDTO.circleType eq 'fleaMarket'}">selected="selected"</c:if>>----------<spring:message code="clubTopic.FleaMarket" />----------</option>
          ...
          <%--开始时间--%>
            <div class="form-group  col-lg-6">
            <label for="beginTime" class="col-sm-3 control-label"><spring:message code="clubTopic.TopicTime"/></label>
          ...
          <%--结束时间--%>
            <div class="form-group  col-lg-6">
              <label for="endTime" class="col-sm-3 control-label"><spring:message code="clubTopic.EndTime"/></label>
              <div class="input-group date form_date col-sm-9" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2">
                <input type="text" class="form-control" placeholder="" id="endTime" value="${circleTopicDTO.endTime}" name="endTime" readonly>
                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
              </div>
              </div>
  ...
  <div class="table-responsive bs-example widget-shadow">
      ...
      <c:forEach items="${circleTopicDTOs}" var="clubTopic" varStatus="vs">
        <tr>
          ...
          <td class="last">
            ...
            <a href="../circle/showBBSReply?circleTopicId=${clubTopic.circleTopicId}" class="a2"><span class="span1"><spring:message code="clubTopic.ShowReply" /></span></a>
            <a href="../circle/delBBSTopic?circleTopicId=${clubTopic.circleTopicId}" class="a3"><span class="span1"><spring:message code="common_delete" /></span></a>
          </td>
        </tr>
      </c:forEach>
      </tbody>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/circle/bbsTopicManage.html?pageIndex={0}"/>
  </div>
