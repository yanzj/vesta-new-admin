...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      ...
      <div class="form-body">
        <form class="form-horizontal" id="addClub" action="../circle/addClub" enctype="MULTIPART/FORM-DATA" method="post">
          ...
          <div class="form-group col-lg-6">
            ...
            <div class="col-sm-9">
              <input type="file" class="form-control" placeholder="" id="circleLogoUrl" name="circleLogoUrl"  style="width: 179px;" onchange="checkClub(this)">
          ...
          <button type="submit" class="btn btn-primary" for="propertySearch" onclick="return testCircle();"><spring:message code="common_confirm"/></button>
