...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../circle/clubManage.html">
          ...
          <a  href="../circle/gotoAddClub" class="btn btn-primary" for="" ><spring:message code="common_add"/></a>
  ...
  <div class="table-responsive bs-example widget-shadow">
      ...
      <c:forEach items="${circleInfoAdminDTOs}" var="circle" varStatus="vs">
        <tr>
          ...
          <td class="last">
            ...
            <a href="../circle/gotoUpdateClub?circleId=${circle.circleId}" class="a2"><span class="span1"><spring:message code="common_update" /></span></a>
            <a href="../circle/deleteClub?circleId=${circle.circleId}" class="a3"><span class="span1"><spring:message code="common_delete" /></span></a>
          </td>
        </tr>
      </c:forEach>
      </tbody>
    ...
    <m:pager pageIndex="${webPage.pageIndex}"
             ...
             submitUrl="${pageContext.request.contextPath }/circle/clubManage.html?pageIndex={0}"/>
  </div>
