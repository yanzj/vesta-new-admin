    ...
    <div class="widget-shadow " data-example-id="basic-forms">
      ...
      <div class="form-body">
        ...
        <div class="form-body" style="min-height:300px">
          <form class="form-horizontal" id="frm" action="../navigationMenu/navigationMenuUpdate" method="post"
                enctype="MULTIPART/FORM-DATA">
            <%--报名人数上限--%>
              <input type="hidden" name="navigationId" value="${navigationMenuDTO.navigationId}">
            <div class="form-group col-lg-10">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" placeholder="" id="navigationName" name="navigationName"
                       value="${navigationMenuDTO.navigationName}">
              </div>
            </div>
            ...
            <div class="form-group col-lg-10">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" placeholder="" id="navigationUrl" name="navigationUrl"
                       value="${navigationMenuDTO.navigationUrl}">
              </div>
            </div>
            ...
            <div class="form-group col-lg-10">
              ...
              <div class="col-sm-9">
                <input type="file" class="form-control" placeholder="" id="homePageimgpath"
                  ...
                  <input type="hidden" value="${navigationMenuDTO.imgUrl}" name="imgUrl" id="imgUrl">
                <div id="demo_homePageimgpath" style="padding-top: 15px;">
                    <c:if test="${navigationMenuDTO.imgUrl != null and navigationMenuDTO.imgUrl != ''}">
                        <img src="${navigationMenuDTO.imgUrl}"
            ...
            <div class="text-center form-group  col-lg-12" style="padding:0;">
              <button type="button" class="btn btn-primary" onclick="validate()">修改</button>
