...
<style>
    ...
    .control_btn a, .control_btn button {
        margin-right: 1rem;
    }
</style>
...
<div class="main-content">
    <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
                 crunMenu="000200010000" username="${propertystaff.staffName}"/>
    <input type="hidden" id="menuId" value="000200010000"/>
    ...
    <div class="forms">
                        ...
                        <form class="form-horizontal" action="../system/versionManage.html" method="get">
                            ...
                            <div class="form-group  col-lg-12 search_button">
                                ...
                                <a href="javascript:void(0);"
                                   onclick="js_gotoAdd('${appVersionDTO.appVersionType}','${appVersionDTO.userType}')"
                                   class="btn btn-primary" for="rolesetAdd"><spring:message code="AppVersion_Add"/></a>
                                <!--集合长度(取决Excel是否可以导出)-->
        ...
        <div class="table-responsive bs-example widget-shadow">
                ...
                <c:forEach items="${appVersionDTOs}" var="version" varStatus="vs">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" onclick="js_del('${version.appVersionId}')" class="a3"><span
            ...
            <m:pager pageIndex="${webPage.pageIndex}"
                     ...
                     submitUrl="${pageContext.request.contextPath }/system/versionManage.html?pageIndex={0}&appVersionType=${appVersionDTO.appVersionType}&state=${appVersionDTO.state}&beginDate=${appVersionDTO.beginDate}&endDate=${appVersionDTO.endDate}"/>
        </div>
    </div>
</div>
</div>
...
<script type="text/javascript">
    ...
    function isExcel() {
        var size = $("#size").val();
        if (size > 0) {
            var href = "../system/exportExcel?pageIndex={0}&appVersionType=${appVersionDTO.appVersionType}&state=${appVersionDTO.state}&beginDate=${appVersionDTO.beginDate}&endDate=${appVersionDTO.endDate}";
    ...
    function js_gotoAdd(appVersionType, userType) {
        $.ajax({
            type: "GET",
            ...
            success: function (data) {
                if (data.error == 1) {
                    window.location.href = "../system/gotoAddVersion?appVersionType=" + appVersionType + "&userType=" + userType;
    ...
    function js_gotoEdit(appVersionId) {
        ...
        if (flag != 0) {
            window.location.href = "../system/gotoUpdateVersion?appVersionId=" + appVersionId;
        }
    }
    ...
    function js_del(appVersionId) {
        ...
        if (flag != 0) {
            ...
            if (myvalue == true) {
                window.location.href = "../system/versionDel?appVersionId=" + appVersionId;
            }
        }
    }
