...
<div class="main-content">
  <vl:leftmenu sysTitle="Vesta Dashboard" menulist="<%=menulist%>" secanViewlist="<%=secanViewlist%>"
               crunMenu="000200030000" username="${propertystaff.staffName}"/>
  <input type="hidden" id="menuId" value="000200030000"/>
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <div class="form-body">
        ...
        <div class="form-body" style="min-height:380px">
          <form class="form-horizontal" id="frm" action="../defaultConfig/saveOrUpdateFunctionDescImg" method="post"
                enctype="MULTIPART/FORM-DATA">
            <input type="hidden" id="id" name="id" value="${defaultConfig.id}">

            <%--功能介绍页设置--%>
            <div class="form-group col-lg-7">
              <label class="col-sm-2 control-label" for="multipartFile">功能介绍页设置</label>
...
//  function submit(){
//    var multipartFile = $("#multipartFile").val();//功能介绍页
//    if (multipartFile == "") {
//      alert("请上传功能介绍页！");
//      return false;
//    }
