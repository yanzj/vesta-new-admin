    ...
    <div class="forms">
        <div class="widget-shadow " data-example-id="basic-forms">
            <div class="form-body" style="overflow:hidden;font-size:13px;line-height:25px;font-family:'微软雅黑';">
                <form class="form-horizontal" id="fromAdd" action="../sApp/saveOrUpdateContent.html" method="post" enctype="MULTIPART/FORM-DATA">
                    <input type="hidden" id="id" name="id" value="${contentDTO.id}">
                    <%-- 所属客户端 --%>
                    ...
                    <%--位置类型--%>
                    <div class="form-group  col-lg-7">
                        <label for="positionType" class="col-sm-3 control-label">位置类型</label>
                        <div class="col-sm-5">
                            <select class="form-control" placeholder="" id="positionType" name="positionType">
                    ...
                    <%--主标题--%>
                    <div class="form-group col-lg-7">
                        <label class="col-sm-3 control-label" for="mainTitle">主标题</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" placeholder="" id="mainTitle" name="mainTitle" value="${contentDTO.mainTitle}">
                        </div>
                    </div>
                    <%--副标题--%>
                    <div class="form-group col-lg-7">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" placeholder="" id="subTitle" name="subTitle" value="${contentDTO.subTitle}">
                        </div>
                    </div>
                    <%-- 展示图 --%>
                    <div class="form-group col-lg-7">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="hidden" id="infoSignImgUrl" name="infoSignImgUrl" value="${contentDTO.infoSignImgUrl}"/>
                        </div>
                    </div>
                    <%-- 展示图原图 --%>
                    <div id="infoSignImg" class="form-group col-lg-7" style="display: none">
                        ...
                        <div class="col-sm-5">
                            <img src="${contentDTO.infoSignImgUrl}" alt="展示图原图" class="img-thumbnail" style="width: auto">
                        </div>
                    </div>
                    <%--链接地址--%>
                    <div class="form-group col-lg-7">
                        <label class="col-sm-3 control-label" for="linkSrc">链接地址</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" placeholder="" id="linkSrc" name="linkSrc" value="${contentDTO.linkSrc}">
                        </div>
                    </div>
                    <%--排序序号--%>
                    <div class="form-group col-lg-7">
                        <label class="col-sm-3 control-label" for="sortNum">排序序号</label>
                        <div class="col-sm-5">
                            <input type="number" class="form-control" placeholder="" id="sortNum" name="sortNum" value="${contentDTO.sortNum}" min="1" max="20">
                        </div>
                    </div>
...
<script type="text/javascript">
    //发布
    function toSave(){
        if($("#mainTitle").val().replace(/(^\s*)|(\s*$)/g, "") == 0){
            alert("请输入主标题！");
            return;
        }
