...
<div class="main-content">
  ...
  <div class="forms">
    <div class="widget-shadow " data-example-id="basic-forms">
      <%--搜索条件开始--%>
      <div class="form-body">
        <form class="form-horizontal" action="../system/sectionAdd">
          <%--部门--%>
          ...
          <button type="submit" class="btn btn-primary" for="propertySearch" onclick="return testSection()"><spring:message code="SECTION_ADD"/></button>
