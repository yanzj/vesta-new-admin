package com.maxrocky.vesta.presistent.projectAuthority.repositoryHbnImpl;
 ...
 */
@Repository
public class ProjectUserAuthorityRepositoryImpl implements ProjectUserAuthorityRepository {
    ...
    public List<UserMapEntity> getUserMap() {
        String sql = "from UserMapEntity where state = '1' and projectModule = 'es' and sourceFrom ='OA' ";
    ...
    public UserMapEntity getUserMapById(String staffId) {
        ...
        sql += " WHERE 1=1 AND staffId='"+staffId+"' AND projectModule='es' ";
    ...
    public List<Object[]> getOAUserManageListByCondition(Map map, WebPage webPage, List<String> idList) {
        ...
        sql.append( " WHERE ra.STATUS='1' AND ui.STAFF_STATE = '1' AND ua.STATUS = '1' AND um.PROJECT_MODULE='es' AND ra.OUT_EMPLOY='0' " );
        //机构名称
    ...
    @Override
    public void saveOrUpdateProjectStaff(UserMapEntity userMapEntity) {
    ...
    @Override
    public List<AuthOuterAgencyEntity> getProjectOuterAgencyList() {
        StringBuilder hql = new StringBuilder( " FROM  AuthOuterAgencyEntity where 1=1 " );
        hql.append( " and status= '1' and (isTemporary='0' OR (isTemporary='1' AND temporaryScope='es'))  ");
    ...
    @Override
    public List<String> getProjectAgencyByStaffId(String staffId) {
        ...
        sql .append( " WHERE ua.STAFF_ID = :id AND ua.STATUS='1' AND aora.STATUS='1' AND aora.OUT_EMPLOY='1' AND (aora.IS_TEMPORARY='0' OR (aora.IS_TEMPORARY='1' AND aora.TEMPORARY_SCOPE='es')) " );
    ...
    @Override
    public List<Object[]> getProjectOuterUserList(Map map, WebPage webPage) {
        List<Object> params = new ArrayList<Object>();
        ...
        sql .append( " LEFT JOIN auth_outer_role_agency aora ON aora.AGENCY_ID = ua.AGENCY_ID " );//外部合作单位组织机构表
        sql .append( " where 1=1 and ua.STATUS='1' and aora.STATUS='1' and ui.STAFF_STATE='1' and um.PROJECT_MODULE = 'es' and aora.OUT_EMPLOY='1' and (aora.IS_TEMPORARY='0' or (aora.IS_TEMPORARY='1' and aora.TEMPORARY_SCOPE='es')) " );
        //所属机构
        if(!StringUtil.isEmpty(map.get("agencyName").toString())){
    ...
    @Override
    public List<String> getProjectAgencyNameByStaffId(String staffId) {
        StringBuilder sql = new StringBuilder(" SELECT ");
    ...
    @Override
    public List<Object[]> getProjectEnabledUserList(Map map, WebPage webPage) {
        List<Object> params = new ArrayList<Object>();
        StringBuilder sql = new StringBuilder( " SELECT DISTINCT " );
        ...
        sql.append( " where 1=1 and um.STATE = '1' and ua.STATUS='1' and ui.STAFF_STATE='1' and ra.STATUS='1' and um.PROJECT_MODULE = 'es' and (ra.IS_TEMPORARY is null or ra.IS_TEMPORARY='0' or (ra.IS_TEMPORARY='1' and ra.TEMPORARY_SCOPE='es'))" );
        //所属机构
        if(!StringUtil.isEmpty(map.get("agencyName").toString())){
            sql.append( " and ( ra.AGENCY_NAME like? ) " );
            params.add(map.get("agencyName").toString());
    ...
    public AuthOuterAgencyEntity getOuterAgencyByName(String agencyName) {
        ...
        hql.append( " WHERE 1=1 AND status='1' AND agencyName='"+agencyName+"' AND outEmploy='1' AND (isTemporary='0' OR (isTemporary='1' AND temporaryScope='es')) " );
        Session session = getCurrentSession();
    ...
    @Override
    public boolean addProjectOuterStaff(UserInformationEntity userInformationEntity) {
