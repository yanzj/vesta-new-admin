 ...
 */
@Entity
@Table(name = "interface_classuser_logs")
public class InterfaceClassUserLogEntity {
    ...
    @Basic
    @Column(name = "INTERFACE_NAME", nullable = true, insertable = true, updatable = true, length = 100)
