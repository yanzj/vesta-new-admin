...
/**
 * Created by Magic on 2016/10/12.
 */
public class PropertyRepairAppDTO {
    ...
    private List<RectifyImageDTO> imgList;//报修完成后list
    private List<RectifyImageDTO> imageList;//报修完成前list
    private String modifyDate;//修改时间
    private String appId;//校验唯一性
    public PropertyRepairAppDTO() {
