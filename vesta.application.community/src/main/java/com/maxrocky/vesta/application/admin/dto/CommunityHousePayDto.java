 ...
 * 交付预约page
 */
public class CommunityHousePayDto implements Serializable {

    private String id;              //房屋预约id号
    ...
    private Integer status;                 //房屋预约交付状态  0，未支付 1，已支付 2，不显示
    ...
    private String appointStatus;   //预约状态，0，未预约 1，已预约


    private List<CommunityHousePayDto> communityHousePays = new ArrayList<CommunityHousePayDto>(); //自关联
    ...
    public List<CommunityHousePayDto> getCommunityHousePays() {
        return communityHousePays;
    }

    public void setCommunityHousePays(List<CommunityHousePayDto> communityHousePays) {
