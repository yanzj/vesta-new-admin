...
public class PropertyOwnerEntity {
    ...
    private String isPushMessage;   //是否发送短信(0,否;1,是)
    private String phone;           //联系方式
    private String messageContent;  //推送短信内容
    private Integer isPushed;       //是否已经发送(0,否;1,是)
    ...
    @Basic
    @Column(name = "is_push_message",nullable = true,length = 1)
    ...
    @Basic
    @Column(name = "is_pushed",nullable = true,length = 1)
