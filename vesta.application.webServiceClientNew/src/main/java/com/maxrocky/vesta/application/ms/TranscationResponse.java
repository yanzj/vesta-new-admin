...
public class TranscationResponse  implements java.io.Serializable {
    private TranscationResMessageBody resBody;
    ...
    public TranscationResponse(
           TranscationResMessageBody resBody,
           ResHeader resHeader) {
     ...
     * @return resBody
     */
    public TranscationResMessageBody getResBody() {
        return resBody;
    }
     ...
     * @param resBody
     */
    public void setResBody(TranscationResMessageBody resBody) {
        this.resBody = resBody;
    }
