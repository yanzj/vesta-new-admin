...
public class SupplierRequest  implements java.io.Serializable {
    private java.lang.String[] projectCodeList;

    public SupplierRequest() {
    }

    public SupplierRequest(
           java.lang.String[] projectCodeList) {
     ...
     */
    public java.lang.String[] getProjectCodeList() {
        return projectCodeList;
    }
     ...
     */
    public void setProjectCodeList(java.lang.String[] projectCodeList) {
        this.projectCodeList = projectCodeList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProjectCodeList() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getProjectCodeList(), i);
                if (obj != null &&
