...
public class MemberInfoUpdateReqMessageBody  implements java.io.Serializable {
    private MemberInfoUpdateReqMessageBodyAccountInfo accountInfo;

    private MemberInfoUpdateReqMessageBodyBaseInfo baseInfo;

    private MemberInfoUpdateReqMessageBodyCarInfo carInfo;

    private MemberInfoUpdateReqMessageBodyCardInfo cardInfo;

    private MemberInfoUpdateReqMessageBodyContactInfo contactInfo;

    private MemberInfoUpdateReqMessageBodyFamilyInfo familyInfo;

    private MemberInfoUpdateReqMessageBodyGradeInfo gradeInfo;

    public MemberInfoUpdateReqMessageBody() {
    }

    public MemberInfoUpdateReqMessageBody(
           MemberInfoUpdateReqMessageBodyAccountInfo accountInfo,
           MemberInfoUpdateReqMessageBodyBaseInfo baseInfo,
           MemberInfoUpdateReqMessageBodyCarInfo carInfo,
           MemberInfoUpdateReqMessageBodyCardInfo cardInfo,
           MemberInfoUpdateReqMessageBodyContactInfo contactInfo,
           MemberInfoUpdateReqMessageBodyFamilyInfo familyInfo,
           MemberInfoUpdateReqMessageBodyGradeInfo gradeInfo) {
     ...
     * @return accountInfo
     */
    public MemberInfoUpdateReqMessageBodyAccountInfo getAccountInfo() {
        return accountInfo;
    }
     ...
     * @param accountInfo
     */
    public void setAccountInfo(MemberInfoUpdateReqMessageBodyAccountInfo accountInfo) {
        this.accountInfo = accountInfo;
    }
     ...
     * @return baseInfo
     */
    public MemberInfoUpdateReqMessageBodyBaseInfo getBaseInfo() {
        return baseInfo;
    }
     ...
     * @param baseInfo
     */
    public void setBaseInfo(MemberInfoUpdateReqMessageBodyBaseInfo baseInfo) {
        this.baseInfo = baseInfo;
    }
     ...
     * @return carInfo
     */
    public MemberInfoUpdateReqMessageBodyCarInfo getCarInfo() {
        return carInfo;
    }
     ...
     * @param carInfo
     */
    public void setCarInfo(MemberInfoUpdateReqMessageBodyCarInfo carInfo) {
        this.carInfo = carInfo;
    }
     ...
     * @return cardInfo
     */
    public MemberInfoUpdateReqMessageBodyCardInfo getCardInfo() {
        return cardInfo;
    }
     ...
     * @param cardInfo
     */
    public void setCardInfo(MemberInfoUpdateReqMessageBodyCardInfo cardInfo) {
        this.cardInfo = cardInfo;
    }
     ...
     * @return contactInfo
     */
    public MemberInfoUpdateReqMessageBodyContactInfo getContactInfo() {
        return contactInfo;
    }
     ...
     * @param contactInfo
     */
    public void setContactInfo(MemberInfoUpdateReqMessageBodyContactInfo contactInfo) {
        this.contactInfo = contactInfo;
    }
     ...
     * @return familyInfo
     */
    public MemberInfoUpdateReqMessageBodyFamilyInfo getFamilyInfo() {
        return familyInfo;
    }
     ...
     * @param familyInfo
     */
    public void setFamilyInfo(MemberInfoUpdateReqMessageBodyFamilyInfo familyInfo) {
        this.familyInfo = familyInfo;
    }
     ...
     * @return gradeInfo
     */
    public MemberInfoUpdateReqMessageBodyGradeInfo getGradeInfo() {
        return gradeInfo;
    }
     ...
     * @param gradeInfo
     */
    public void setGradeInfo(MemberInfoUpdateReqMessageBodyGradeInfo gradeInfo) {
        this.gradeInfo = gradeInfo;
    }
