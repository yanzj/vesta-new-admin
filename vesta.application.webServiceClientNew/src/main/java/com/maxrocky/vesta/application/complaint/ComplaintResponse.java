...
public class ComplaintResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the header value for this ComplaintResponse.
     * 
     * @return header
     */
    ...
    /**
     * Sets the header value for this ComplaintResponse.
     * 
     * @param header
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ComplaintResponse)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ComplaintResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/JM.MemberQuality.DataContract.Model", "ComplaintResponse"));
