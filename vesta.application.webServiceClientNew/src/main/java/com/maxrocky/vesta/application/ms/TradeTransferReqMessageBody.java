...
public class TradeTransferReqMessageBody  implements java.io.Serializable {
    private TradeTransferReqMessageBodyOrderInfo orderInfo;

    private TradeTransferReqMessageBodyReceipt receipt;

    public TradeTransferReqMessageBody() {
    }

    public TradeTransferReqMessageBody(
           TradeTransferReqMessageBodyOrderInfo orderInfo,
           TradeTransferReqMessageBodyReceipt receipt) {
     ...
     * @return orderInfo
     */
    public TradeTransferReqMessageBodyOrderInfo getOrderInfo() {
        return orderInfo;
    }
     ...
     * @param orderInfo
     */
    public void setOrderInfo(TradeTransferReqMessageBodyOrderInfo orderInfo) {
        this.orderInfo = orderInfo;
    }
     ...
     * @return receipt
     */
    public TradeTransferReqMessageBodyReceipt getReceipt() {
        return receipt;
    }
     ...
     * @param receipt
     */
    public void setReceipt(TradeTransferReqMessageBodyReceipt receipt) {
        this.receipt = receipt;
    }
