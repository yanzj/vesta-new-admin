...
public class TradeTransferReqMessageBodyOrderInfo  implements java.io.Serializable {
    private TradeTransferReqMessageBodyOrderInfoOrderHeader orderHeader;

    private TradeTransferReqMessageBodyOrderInfoOrderItems[] orderItems;

    public TradeTransferReqMessageBodyOrderInfo() {
    }

    public TradeTransferReqMessageBodyOrderInfo(
           TradeTransferReqMessageBodyOrderInfoOrderHeader orderHeader,
           TradeTransferReqMessageBodyOrderInfoOrderItems[] orderItems) {
     ...
     * @return orderHeader
     */
    public TradeTransferReqMessageBodyOrderInfoOrderHeader getOrderHeader() {
        return orderHeader;
    }
     ...
     * @param orderHeader
     */
    public void setOrderHeader(TradeTransferReqMessageBodyOrderInfoOrderHeader orderHeader) {
        this.orderHeader = orderHeader;
    }
     ...
     * @return orderItems
     */
    public TradeTransferReqMessageBodyOrderInfoOrderItems[] getOrderItems() {
        return orderItems;
    }
     ...
     * @param orderItems
     */
    public void setOrderItems(TradeTransferReqMessageBodyOrderInfoOrderItems[] orderItems) {
        this.orderItems = orderItems;
    }
