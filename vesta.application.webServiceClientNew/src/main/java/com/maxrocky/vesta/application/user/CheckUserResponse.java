...
public class CheckUserResponse  implements java.io.Serializable {
    private boolean out;
    ...
    /**
     * Gets the out value for this CheckUserResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this CheckUserResponse.
     * 
     * @param out
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost/services/HrmService", ">checkUserResponse"));
