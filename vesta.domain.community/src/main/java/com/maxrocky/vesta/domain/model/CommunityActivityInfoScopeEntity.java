 ...
 */
@Entity
@Table(name = "community_activityInfo_scope")
public class CommunityActivityInfoScopeEntity implements Serializable {
    private String id;//
    ...
    @Basic
    @Column(name = "activityId", length = 50, nullable = true, updatable = true)
