...
/**
 * Created by fanlongfei on 2016/7/1.城市、项目的关联表
 * 新闻与
 */
@Entity
@Table(name = "community_news_scope")
public class CommunityNewScope {
    ...
    @Basic
    @Column(name = "community_detail_id", length = 50, nullable = true, updatable = true)
