package com.maxrocky.vesta.domain.projectAccredit.repository;
 ...
 */
public interface ProjectUserAccreditRepository {

    //获取所有组织架构
    List<AuthAgencyESEntity> getProjectAgencyListAll();

    //获取所有组织架构
    List<AuthAgencyESEntity> getProjectAgencyListAllByIds(List<String> updateProject);
    ...
    //获取外部创建的组织架构
    List<AuthOuterAgencyEntity> getProjectAuthOuterAgency();
    ...
    //通过Id获取项目层级下的角色
    List<AuthRoleseEntity> getProjectRoleByAgencyId(String agencyId);

    //通过Id获取项目层级下的甲方角色
    List<AuthRoleseEntity> getOwnerRoleByAgencyId(String agencyId);

    //通过Id获取该项目层级信息
    AuthAgencyESEntity getAuthAgencyByAgencyId(String agencyId);
    ...
    //根据ID获取角色  项目  人员关系
    RoleStaffProjectMapESEntity getRoleStaffProjectMapById(String id);

    //修改人员项目关系
    void savePrjectRoleStaffProjectMap(RoleStaffProjectMapESEntity roleStaffProjectMapESEntity);

    //按员工id+功能点级别查询所有功能点id 和对应的项目id
    List<String> getProjectAuthFunctionAndProjectIdByStaffId(String function,String staffId, String level);
