...
public class Cardstatus implements java.io.Serializable {
    ...
    public static final java.lang.String _Invalidate = "Invalidate";
    public static final java.lang.String _Frozen = "Frozen";
    public static final Cardstatus Validate = new Cardstatus(_Validate);
    public static final Cardstatus Invalidate = new Cardstatus(_Invalidate);
    public static final Cardstatus Frozen = new Cardstatus(_Frozen);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/FX.Membership.DataContract", "cardstatus"));
    }
    /**
