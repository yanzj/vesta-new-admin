...
public class MemberRegisterResMessageBody  implements java.io.Serializable {
    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyAccountInfo accountInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyBaseInfo baseInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyCardInfo cardInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyContactInfo contactInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyGradeInfo gradeInfo;
    ...
    public MemberRegisterResMessageBody(
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyAccountInfo accountInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyBaseInfo baseInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyCardInfo cardInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyContactInfo contactInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyGradeInfo gradeInfo,
     ...
     * @return accountInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyAccountInfo getAccountInfo() {
        return accountInfo;
    }
     ...
     * @param accountInfo
     */
    public void setAccountInfo(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyAccountInfo accountInfo) {
        this.accountInfo = accountInfo;
    }
     ...
     * @return baseInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyBaseInfo getBaseInfo() {
        return baseInfo;
    }
     ...
     * @param baseInfo
     */
    public void setBaseInfo(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyBaseInfo baseInfo) {
        this.baseInfo = baseInfo;
    }
     ...
     * @return cardInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyCardInfo getCardInfo() {
        return cardInfo;
    }
     ...
     * @param cardInfo
     */
    public void setCardInfo(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyCardInfo cardInfo) {
        this.cardInfo = cardInfo;
    }
     ...
     * @return contactInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyContactInfo getContactInfo() {
        return contactInfo;
    }
     ...
     * @param contactInfo
     */
    public void setContactInfo(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyContactInfo contactInfo) {
        this.contactInfo = contactInfo;
    }
     ...
     * @return gradeInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyGradeInfo getGradeInfo() {
        return gradeInfo;
    }
     ...
     * @param gradeInfo
     */
    public void setGradeInfo(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBodyGradeInfo gradeInfo) {
        this.gradeInfo = gradeInfo;
    }
