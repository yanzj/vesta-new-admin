...
import com.maxrocky.vesta.application.inf.MembershipService;
...
public class MembershipServiceLocator extends org.apache.axis.client.Service implements MembershipService {
    ...
    private java.lang.String FXEndPoint_address = "http://172.16.124.55/MemberShip/MembershipService.svc";
