...
public class MemberInfoUpdateResponse  implements java.io.Serializable {
    private com.maxrocky.vesta.application.ms.MemberInfoUpdateResBody resBody;
    ...
    public MemberInfoUpdateResponse(
           com.maxrocky.vesta.application.ms.MemberInfoUpdateResBody resBody,
     ...
     * @return resBody
     */
    public com.maxrocky.vesta.application.ms.MemberInfoUpdateResBody getResBody() {
        return resBody;
    }
     ...
     * @param resBody
     */
    public void setResBody(com.maxrocky.vesta.application.ms.MemberInfoUpdateResBody resBody) {
        this.resBody = resBody;
    }
