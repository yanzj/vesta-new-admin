...
public class InspectionResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the header value for this InspectionResponse.
     * 
     * @return header
     */
    ...
    /**
     * Sets the header value for this InspectionResponse.
     * 
     * @param header
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof InspectionResponse)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InspectionResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/JM.MemberQuality.DataContract.Model", "InspectionResponse"));
