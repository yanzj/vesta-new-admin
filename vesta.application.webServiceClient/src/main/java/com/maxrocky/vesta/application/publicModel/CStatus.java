...
public class CStatus implements java.io.Serializable {
    ...
    // Constructor
    protected CStatus(String value) {
        _value_ = value;
    ...
    public static final String _returnVisit = "returnVisit";
    ...
    public static CStatus fromValue(String value)
    ...
    public static CStatus fromString(String value)
          throws IllegalArgumentException {
