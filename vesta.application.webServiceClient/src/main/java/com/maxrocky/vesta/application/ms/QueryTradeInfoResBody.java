...
public class QueryTradeInfoResBody  implements java.io.Serializable {
    ...
    private com.maxrocky.vesta.application.ms.QueryTradeInfoResMessageBody[] messageBody;
    ...
    public QueryTradeInfoResBody(
           ...
           com.maxrocky.vesta.application.ms.QueryTradeInfoResMessageBody[] messageBody) {
     ...
     * @return messageBody
     */
    public com.maxrocky.vesta.application.ms.QueryTradeInfoResMessageBody[] getMessageBody() {
        return messageBody;
    }
     ...
     * @param messageBody
     */
    public void setMessageBody(com.maxrocky.vesta.application.ms.QueryTradeInfoResMessageBody[] messageBody) {
        this.messageBody = messageBody;
    }
