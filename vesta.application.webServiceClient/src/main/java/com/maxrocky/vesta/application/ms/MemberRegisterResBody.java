...
public class MemberRegisterResBody  implements java.io.Serializable {
    ...
    private com.maxrocky.vesta.application.ms.MemberRegisterResMessageBody messageBody;
    ...
    public MemberRegisterResBody(
           ...
           com.maxrocky.vesta.application.ms.MemberRegisterResMessageBody messageBody) {
     ...
     * @return messageBody
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterResMessageBody getMessageBody() {
        return messageBody;
    }
     ...
     * @param messageBody
     */
    public void setMessageBody(com.maxrocky.vesta.application.ms.MemberRegisterResMessageBody messageBody) {
        this.messageBody = messageBody;
    }
