...
public class QueryTradeInfoResponse  implements java.io.Serializable {
    private com.maxrocky.vesta.application.ms.QueryTradeInfoResBody resBody;
    ...
    public QueryTradeInfoResponse(
           com.maxrocky.vesta.application.ms.QueryTradeInfoResBody resBody,
     ...
     * @return resBody
     */
    public com.maxrocky.vesta.application.ms.QueryTradeInfoResBody getResBody() {
        return resBody;
    }
     ...
     * @param resBody
     */
    public void setResBody(com.maxrocky.vesta.application.ms.QueryTradeInfoResBody resBody) {
        this.resBody = resBody;
    }
