...
public class Progress implements java.io.Serializable {
    ...
    // Constructor
    protected Progress(String value) {
        _value_ = value;
        _table_.put(_value_,this);
    }

    public static final String _activated = "activated";
    public static final String _acceptanceBy = "acceptanceBy";
    public static final String _acceptanceNotThrough = "acceptanceNotThrough";
    public static final String _absence = "absence";
    ...
    public static Progress fromValue(String value)
