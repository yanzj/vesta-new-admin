...
public class QueryTradeInfoReqMessageBody  implements java.io.Serializable {
    ...
    private com.maxrocky.vesta.application.ms.Integraltype receiptType;
    ...
    public QueryTradeInfoReqMessageBody(
           ...
           com.maxrocky.vesta.application.ms.Integraltype receiptType,
     ...
     * @return receiptType
     */
    public com.maxrocky.vesta.application.ms.Integraltype getReceiptType() {
        return receiptType;
    }
     ...
     * @param receiptType
     */
    public void setReceiptType(com.maxrocky.vesta.application.ms.Integraltype receiptType) {
        this.receiptType = receiptType;
    }
