...
public class MemberRegisterReqMessageBody  implements java.io.Serializable {
    private com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyAccountInfo accountInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyBaseInfo baseInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyCardInfo cardInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyContactInfo contactInfo;

    private com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyGradeInfo gradeInfo;

    public MemberRegisterReqMessageBody() {
    }

    public MemberRegisterReqMessageBody(
           com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyAccountInfo accountInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyBaseInfo baseInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyCardInfo cardInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyContactInfo contactInfo,
           com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyGradeInfo gradeInfo) {
     ...
     * @return accountInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyAccountInfo getAccountInfo() {
        return accountInfo;
    }
     ...
     * @param accountInfo
     */
    public void setAccountInfo(com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyAccountInfo accountInfo) {
        this.accountInfo = accountInfo;
    }
     ...
     * @return baseInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyBaseInfo getBaseInfo() {
        return baseInfo;
    }
     ...
     * @param baseInfo
     */
    public void setBaseInfo(com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyBaseInfo baseInfo) {
        this.baseInfo = baseInfo;
    }
     ...
     * @return cardInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyCardInfo getCardInfo() {
        return cardInfo;
    }
     ...
     * @param cardInfo
     */
    public void setCardInfo(com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyCardInfo cardInfo) {
        this.cardInfo = cardInfo;
    }
     ...
     * @return contactInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyContactInfo getContactInfo() {
        return contactInfo;
    }
     ...
     * @param contactInfo
     */
    public void setContactInfo(com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyContactInfo contactInfo) {
        this.contactInfo = contactInfo;
    }
     ...
     * @return gradeInfo
     */
    public com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyGradeInfo getGradeInfo() {
        return gradeInfo;
    }
     ...
     * @param gradeInfo
     */
    public void setGradeInfo(com.maxrocky.vesta.application.ms.MemberRegisterReqMessageBodyGradeInfo gradeInfo) {
        this.gradeInfo = gradeInfo;
    }
