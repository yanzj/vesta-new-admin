...
public class MemberInfoUpdateReqMessageBodyCarInfo  implements java.io.Serializable {
    private com.maxrocky.vesta.application.ms.Carpower carPower;

    private com.maxrocky.vesta.application.ms.Cartype carType;
    ...
    public MemberInfoUpdateReqMessageBodyCarInfo(
           com.maxrocky.vesta.application.ms.Carpower carPower,
           com.maxrocky.vesta.application.ms.Cartype carType,
           java.lang.String id,
     ...
     * @return carPower
     */
    public com.maxrocky.vesta.application.ms.Carpower getCarPower() {
        return carPower;
    }
     ...
     * @param carPower
     */
    public void setCarPower(com.maxrocky.vesta.application.ms.Carpower carPower) {
        this.carPower = carPower;
    }
     ...
     * @return carType
     */
    public com.maxrocky.vesta.application.ms.Cartype getCarType() {
        return carType;
    }
     ...
     * @param carType
     */
    public void setCarType(com.maxrocky.vesta.application.ms.Cartype carType) {
        this.carType = carType;
    }
