...
@Entity
@Table(name = "user_agency",uniqueConstraints = {@UniqueConstraint(columnNames = {"STAFF_ID","AGENCY_ID"})})
public class UserAgencyEntity {
    ...
    private String sourceFrom;      //来源  同步OA数据的时候用到 其他并不需要  external  外部   OA  OA同步
